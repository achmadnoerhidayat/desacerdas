...
$cari_kd=mysqli_query($koneksi,"SELECT file_photo, file_name FROM tbuser WHERE nip='$nip'");
	...
	if(isset($_POST['btntambah'])) {
		...
		if($cbort2=='') {
			mysqli_query($koneksi,"INSERT INTO tbrapbes_detail (tahun, kode, uraian, anggaran, keterangan) 
								VALUES ('$txtthn','$cbort1','$txturaian','$txtanggaran','$txtket')");
		} elseif($cbort2<>'') {
			mysqli_query($koneksi,"INSERT INTO tbrapbes_detail (tahun, kode, uraian, anggaran, keterangan) 
								VALUES ('$txtthn','$cbort2','$txturaian','$txtanggaran','$txtket')");			
		}
	}
                                ...
                                <div class="preview">
									...
									<div class="mt-3">
										<select class="input pr-12 w-full border col-span-4" id="cbodukuh" name="cbodukuh" required>
																	...
																	<?php
																		$sql="select kode, nama FROM tbrek where length(kode)='1'";
									...
									<div class="mt-3">				
														...
														<select class="input pr-12 w-full border col-span-4" name="cbort" id="cbort">
																	<option value="">Pilih Sub Rekening</option>
														</select>
                                    </div>
									<div class="mt-3">				
													
														<select class="input pr-12 w-full border col-span-4" name="cbort1" id="cbort1">
																	<option value="">Pilih Sub Rekening</option>
														</select>
                                    </div>
									<div class="mt-3">				
													
														<select class="input pr-12 w-full border col-span-4" name="cbort2" id="cbort2" >
																	<option value="">Pilih Sub Rekening</option>
														</select>
                                    </div>
									
                                        <input type="text" class="input w-full border mt-2" 
										id="txturaian" name="txturaian" placeholder="Uraian (Jika ada)">
                                    
                                        <input type="text" class="input w-full border mt-2" 
										id="txtanggaran" name="txtanggaran" placeholder="Anggaran (Rp)">
                                    
                                        <input type="text" class="input w-full border mt-2" 
										id="txtket" name="txtket" placeholder="Keterangan">
									</div>
									<div class="mt-3">
										<div class="relative mt-2 text-right">
											<button type="submit" name="btntambah" class="button text-white bg-theme-1 shadow-md mr-2">+ Tambahkan</button>
										</div>
									</div>
								</div>
...
<script>
    ...
    $("#cbort").change(function(){
   
        // variabel dari nilai combo box provinsi
        var id_kec = $("#cbort").val();
...
<script>
    ...
    $("#cbort1").change(function(){
   
        // variabel dari nilai combo box provinsi
        var id_kec = $("#cbort1").val();
