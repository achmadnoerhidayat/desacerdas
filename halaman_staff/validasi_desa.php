                ...
                <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
                    ...
                    <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
                        <button type="button" class="button box text-gray-700 mr-2 flex items-center ml-auto sm:ml-0"> 
							<a href="profil_edit.php"> Ubah </a> 
						</button>
                        <div class="dropdown relative">
                            <button class="dropdown-toggle button text-white bg-theme-1 shadow-md flex items-center"> Tambah <i class="w-4 h-4 ml-2" data-feather="chevron-down"></i> </button>
                            <div class="dropdown-box mt-10 absolute w-40 top-0 right-0 z-20">
                                <div class="dropdown-box__content box p-2">
                                    <a href="dusun_add.php" class="flex items-center block p-2 transition duration-300 ease-in-out bg-white hover:bg-gray-200 rounded-md"> <i data-feather="plus" class="w-4 h-4 mr-2"></i> Dusun / Dukuh </a>
                                </div>
                            </div>
                        </div>
                        <button type="button" class="button box text-gray-700 mr-2 flex items-center ml-auto sm:ml-0"> 
                                    ...
                                    <div class="dropdown-box mt-8 absolute w-40 top-0 right-0 z-20">
                                        <div class="dropdown-box__content box p-2">
											<?php 
												if($file_logo=='') {
											?>
                                            <a href="logo_add.php" class="flex items-center block p-2 transition duration-300 ease-in-out bg-white hover:bg-gray-200 rounded-md"> <i data-feather="plus" class="w-4 h-4 mr-2"></i> Upload Logo </a>											
											<?php
												} else {
											?>
                                            <a href="logo_edit.php" class="flex items-center block p-2 transition duration-300 ease-in-out bg-white hover:bg-gray-200 rounded-md"> <i data-feather="edit-2" class="w-4 h-4 mr-2"></i> Edit Logo </a>											
											<?php
												}
											?>
                                        </div>
                    ...
                    <div class="intro-y blog col-span-12 md:col-span-6 box">			
						...
						<table class="table">
											...
											<div class="dropdown-box mt-5 absolute w-56 top-0 right-0 z-20">
												<div class="dropdown-box__content box">
													<div class="p-4 border-b border-gray-200 font-medium">
														<a href="dusun_edit.php?id=<?php echo $id_dukuh; ?>" class="flex items-center block p-2 transition duration-300 ease-in-out bg-white hover:bg-gray-200 rounded-md"> <i data-feather="edit-2" class="w-4 h-4 text-gray-700 mr-2"></i> Edit Dusun </a>
														<a href="dusun_del.php?id=<?php echo $id_dukuh; ?>" 
														onclick="return confirm('Data Dusun Berikut dengan data RW/RT dibawahnya akan dihapus. Lanjutkan?')" 
														class="flex items-center block p-2 transition duration-300 ease-in-out bg-white hover:bg-gray-200 rounded-md"> <i data-feather="trash" class="w-4 h-4 text-gray-700 mr-2"></i> Hapus Dusun </a>											
													</div>
													<div class="p-2">
														<a href="rw_add.php?iddusun=<?php echo $id_dukuh; ?>" class="flex items-center block p-2 transition duration-300 ease-in-out bg-white hover:bg-gray-200 rounded-md"> <i data-feather="plus" class="w-4 h-4 text-gray-700 mr-2"></i> RW </a>
													 </div>
												</div>
											</div>
									</div>															
							...
							<tr>
								...
								<td width="50%">
                                        <div class="flex">
											<a href="rw_edit.php?id=<?php echo $data1['id']?>" class="rw-edit-btn flex items-contents-center py-1 px-2 my-2 ml-3 transition duration-300 ease-in-out border border-theme-1 text-theme-1 rounded-md w-24">
												<i data-feather="edit" class="w-4 h-4 mr-3"></i> Edit RW
											</a>
											<a href="rw_del.php?id=<?php echo $data1['id']?>" onclick="return confirm('Data RW akan dihapus. Lanjutkan?')" 
												class="hapus-rw flex items-contents-center py-1 px-2 my-2 ml-3 transition duration-300 ease-in-out border border-theme-6 text-theme-6 rounded-md w-32">
							...
							<tr>
								...
								<td width="50%">
                                        <div class="flex">
											<a href="rt_edit.php?id=<?php echo $data2['id_rt']?>" class="rw-edit-btn flex items-contents-center py-1 px-2 my-2 ml-3 transition duration-300 ease-in-out border border-theme-1 text-theme-1 rounded-md w-24">
												<i data-feather="edit" class="w-4 h-4 mr-3"></i> Edit RT
											</a>
											<a href="rt_del.php?id=<?php echo $data2['id_rt']?>" onclick="return confirm('Data RT akan dihapus. Lanjutkan?')" 
												class="hapus-rw flex items-contents-center py-1 px-2 my-2 ml-3 transition duration-300 ease-in-out border border-theme-6 text-theme-6 rounded-md w-32">
							...
							<tr>
								<td width="10%"></td>
								<td width="40%">
									<a href="rt_add.php?idrw=<?php echo $id_rw; ?>" class="rt-add flex items-center w-32 p-2 transition duration-300 ease-in-out border border-theme-3 text-theme-3 bg-white hover:bg-gray-200 rounded-md">
