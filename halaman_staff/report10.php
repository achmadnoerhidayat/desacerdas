...
use Dompdf\Dompdf;
$dompdf = new Dompdf();
$query = mysqli_query($koneksi,"SELECT distinct(id_dukuh) as kd_dukuh FROM tbpenduduk where kode='$kd_kel'");
$html = '<center><font size="3">REKAPITULASI JUMLAH PENDUDUK BULAN 
'.$nm_bulan.' TAHUN '.$cbothn.'<br>
PEMERINTAH DESA '.$nm_kel.'<br>
...
// --- End Penduduk Awal Bulan -----------
    ...
    $html .= "<tr>
        ...
        <td align='center'><font size=2>".$nm_dukuh."</font></td>
	...
	<td align='center'><font size=2>".$jml_kk_awal."</font></td>
	<td align='center'><font size=2>".$jml_anggota_awal."</font></td>
	<td align='center'><font size=2>".$jml_jiwa_awal."</font></td>
	
	<td align='center'><font size=2>".$jml_laki_wna_lahir."</font></td>
	<td align='center'><font size=2>".$jml_perempuan_wna_lahir."</font></td>
	<td align='center'><font size=2>".$jml_laki_wni_lahir."</font></td>
	<td align='center'><font size=2>".$jml_perempuan_wni_lahir."</font></td>

	<td align='center'><font size=2>".$jml_laki_wna_datang."</font></td>
	<td align='center'><font size=2>".$jml_perempuan_wna_datang."</font></td>
	<td align='center'><font size=2>".$jml_laki_wni_datang."</font></td>
	<td align='center'><font size=2>".$jml_perempuan_wni_datang."</font></td>

	<td align='center'><font size=2>".$jml_laki_wna_meninggal."</font></td>
	<td align='center'><font size=2>".$jml_perempuan_wna_meninggal."</font></td>
	<td align='center'><font size=2>".$jml_laki_wni_meninggal."</font></td>
	<td align='center'><font size=2>".$jml_perempuan_wni_meninggal."</font></td>

	<td align='center'><font size=2>".$jml_laki_wna_pindah."</font></td>
	<td align='center'><font size=2>".$jml_perempuan_wna_pindah."</font></td>
	<td align='center'><font size=2>".$jml_laki_wni_pindah."</font></td>
	<td align='center'><font size=2>".$jml_perempuan_wni_pindah."</font></td>

	<td align='center'><font size=2>".$jml_laki_wna_akhir."</font></td>
	<td align='center'><font size=2>".$jml_perempuan_wna_akhir."</font></td>
	<td align='center'><font size=2>".$jml_laki_wni_akhir."</font></td>
	<td align='center'><font size=2>".$jml_perempuan_wni_akhir."</font></td>
	<td align='center'><font size=2>".$jml_kk_akhir_bulan."</font></td>
	<td align='center'><font size=2>".$jml_anggota_akhir_bulan."</font></td>
	<td align='center'><font size=2>".$jml_jiwa_akhir."</font></td>
...
$dompdf->stream('Rekapitulasi Jumlah Penduduk.pdf');
?>