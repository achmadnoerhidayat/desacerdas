...
<body>
	...
	<table border="1">
		...
		$data = mysqli_query($koneksi,"select *, DATE_FORMAT(tanggal,'%d/%m/%Y') AS tgl FROM tbinventaris where kode='$kd_kel'");
		$no = 0;
	...
	$no++;
		...
		<tr>
			...
			<td><font size="2"><?php echo $d['volume']; ?></font></td>
			<td><font size="2"><?php echo number_format($d['biaya'],0); ?></font></td>
			<td><font size="2"><?php echo $d['lokasi']; ?></font></td>
