<?php
	...
	$cari_kd=mysqli_query($koneksi,"SELECT 
									...
									fld_krmbrg1,fld_krmbrg2,fld_krmbrg3, 
									DATE_FORMAT(fld_krmbrg4,'%d %M %Y') AS tanggal_mulai,
									DATE_FORMAT(fld_krmbrg5,'%d %M %Y') AS tanggal_selesai	
									FROM tbbuatsurat 
	...
	$fld_krmbrg1=$tm_cari['fld_krmbrg1'];
	$fld_krmbrg2=$tm_cari['fld_krmbrg2'];
	$fld_krmbrg3=$tm_cari['fld_krmbrg3'];	

	$tanggal_mulai=$tm_cari['tanggal_mulai'];
	$tanggal_selesai=$tm_cari['tanggal_selesai'];
