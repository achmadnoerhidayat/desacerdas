<?php
	...
	$cari_kd=mysqli_query($koneksi,"SELECT 
									...
									WHERE id_kel='$kd_kel' and id_kategori='1'");
	$tm_cari=mysqli_fetch_array($cari_kd);
	...
	$html = '<head>
        ...
        <!-- Begin : Isi Surat -->
        <div style="margin-top: 30pt;">Yang bertanda tangan di bawah ini, '.$jabatan.' '.$nm_kel.' dengan ini menerangkan  :</div>
        ...
        <div style="text-indent: 40px; margin-top: 30pt;">
            Berdasarkan pengamatan Kami, yang bersangkutan benar-benar penduduk yang berdomisili di Desa '.$nm_kel.' dan terdaftar dalam register kependudukan Kami dengan NIK '.$nik.'.
        </div>
        <div style="text-indent: 40px; margin-top: 30pt;">
...
$dompdf->stream('surat_keteragan_domisili.pdf',array("Attachment"=>0));
//$dompdf->stream('surat_keteragan_domisili.pdf');
?>
