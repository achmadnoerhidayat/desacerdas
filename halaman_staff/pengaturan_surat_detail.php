...
session_start();
	...
	$id = $_POST['txtid'];
	$cari_kd=mysqli_query($koneksi,"SELECT nm_kategori FROM tbkategori_surat WHERE id_kategori='$id'");
	$tm_cari=mysqli_fetch_array($cari_kd);
	$nm_kategori=$tm_cari['nm_kategori'];

	$data = mysqli_query($koneksi,"SELECT * FROM tbpengaturan_surat WHERE id_kel='$kd_kel' and id_kategori='$id'"); 
	$cek = mysqli_num_rows($data);
	if($cek > 0){
		$cari_kd=mysqli_query($koneksi,"SELECT alamat, tempat, jabatan, nama, nip, logo_surat,no_pengaturan,
						nm_kab, nm_kec, nm_kel, nm_surat 
						FROM tbpengaturan_surat WHERE id_kel='$kd_kel' and id_kategori='$id'");
		$tm_cari=mysqli_fetch_array($cari_kd);
		$alamat=$tm_cari['alamat'];
		$tempat=$tm_cari['tempat'];
		...
		$fld_nama_surat=$tm_cari['nm_surat'];		
	} else {
		$alamat="";
		$tempat="";
		$jabatan="";
	...
	if(isset($_POST['btnsimpan'])) {	
		...
		$txtkec = $_POST['txtkec'];
		$txtkel = $_POST['txtkel'];
		$txtnamasurat = $_POST['txtnamasurat'];		
		...
		$cek = mysqli_num_rows($data);
		if($cek > 0){
			$cari_kd=mysqli_query($koneksi,"SELECT id FROM tbpengaturan_surat WHERE id_kel='$kd_kel' and id_kategori='$id'");
			$tm_cari=mysqli_fetch_array($cari_kd);
			$id=$tm_cari['id'];
			
			move_uploaded_file($temp, $folder . $name);
			mysqli_query($koneksi,"UPDATE tbpengaturan_surat 
						SET alamat='$txtalamat', tempat='$txttempat', jabatan='$txtjabatan', 
						nama='$txtnm', nip='$nip', logo_surat='$foto', no_pengaturan='$txtkode', 
						nm_kab='$txtkab', nm_kec='$txtkec', nm_kel='$txtkel', nm_surat='$txtnamasurat' 	
						where id='$id'");
		} else {
			move_uploaded_file($temp, $folder . $name);
			mysqli_query($koneksi,"INSERT INTO tbpengaturan_surat 
								(id_kel, id_kategori, alamat, tempat, jabatan, nama, nip, logo_surat,no_pengaturan,
								nm_kab, nm_kec, nm_kel, nm_surat) 
								VALUES 
								('$txtkdkel','$txtid','$txtalamat','$txttempat','$txtjabatan','$txtnm','$nip','$foto','$txtkode',
								'$txtkab','$txtkec','$txtkel','$txtnamasurat')");
		}
							
		echo"<script>window.alert('Data Berhasil Disimpan!');window.location=('pengaturan_surat.php');</script>";		
	}
?>
...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="index.php" class="">Home</a> 
				...
				<div class="intro-y flex items-center mt-8">
					<h2 class="text-lg font-medium mr-auto">Pengaturan Kop <?php echo $nm_kategori; ?></h2>
				</div>
					...
					<div class="box intro-y p-5 mt-2">
						<div class="flex-row">
							<div class="w-full mt-4">
								<label class="mb-2 block">Nama Surat</label>
								<input type="text" class="input w-full border mt-2" id="txtnamasurat" name="txtnamasurat" 
								value="<?php echo $fld_nama_surat; ?>" required autocomplete="off">
							</div>
							<div class="w-full mt-4">
								<label class="mb-2 block">Kode Surat</label>
								<input type="text" class="input w-full border mt-2" id="txtkode" name="txtkode" 
								value="<?php echo $no_pengaturan; ?>" required autocomplete="off">
							</div>
							<div class="w-full mt-4">
								<label class="mb-2 block">Logo Surat</label>
								<input type="file" id="gambar" name="gambar" class="input w-full border mt-2" />
								<span class="text-red-500">*</span> <span class="text-xs">Tipe File PNG, JPG, JPEG, Ukuran maksimum 5MB</span>
							</div>
							<div class="w-full mt-4">
								<label class="mb-2 block">Pemerintahan</label>
								<input type="text" class="input w-full border mt-2" id="txtkab" name="txtkab" 
								value="<?php echo $fld_nama_kab; ?>" required autocomplete="off">
							</div>
							<div class="w-full mt-4">
								<label class="mb-2 block">Kecamatan</label>
								<input type="text" class="input w-full border mt-2" id="txtkec" name="txtkec" 
								value="<?php echo $fld_nama_kec; ?>" required autocomplete="off">
							</div>
							<div class="w-full mt-4">
								<label class="mb-2 block">Desa</label>
								<input type="text" class="input w-full border mt-2" id="txtkel" name="txtkel" 
								value="<?php echo $fld_nama_kel; ?>" required autocomplete="off">
							</div>
							<div class="w-full mt-4">
								<label class="mb-2 block">Alamat Lengkap</label>
								<input type="text" class="input w-full border mt-2" id="txtalamat" name="txtalamat" 
								value="<?php echo $alamat; ?>" required autocomplete="off" >
							</div>
							<div class="w-full mt-4">
								<label class="mb-2 block">Tempat Penerbitan Surat</label>
								<input type="text" class="input w-full border mt-2" id="txttempat" name="txttempat" 
								value="<?php echo $tempat; ?>" required autocomplete="off">
							</div>
							<div class="w-full mt-4">
								<label class="mb-2 block">Jabatan Penanggung Jawab</label>
								<input type="text" class="input w-full border mt-2" id="txtjabatan" name="txtjabatan" 
								value="<?php echo $jabatan; ?>" required autocomplete="off">
							</div>
							<div class="w-full mt-4">
								<label class="mb-2 block">Nama Penanggung Jawab</label>
								<input type="text" class="input w-full border mt-2" id="txtnm" name="txtnm" 
								value="<?php echo $nama; ?>" required autocomplete="off">
							</div>
							<div class="w-full mt-4">
								<label class="mb-2 block">NIP Penanggung Jawab</label>
								<input type="text" class="input w-full border mt-2" id="txtnip" name="txtnip" 
								value="<?php echo $nip; ?>" required autocomplete="off">
							</div>
						</div>
