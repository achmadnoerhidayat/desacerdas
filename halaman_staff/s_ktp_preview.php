<?php
	...
	$nm_kab=$tm_cari['nama'];
		...
		$fld_layanan=$_GET['txt1'];
		$fld_keperluan=$_GET['txt2'];
		$fld_keterangan=$_GET['txt3'];		
		$nama=$_GET['txt4'];	
	...
	$cari_kd=mysqli_query($koneksi,"SELECT 
									...
									WHERE id_kel='$kd_kel' and id_kategori='16'");
	$tm_cari=mysqli_fetch_array($cari_kd);
	...
	$html = '<table width="100%">
			...
			<br>
			<center>
				<b><u>SURAT PENGANTAR KARTU TANDA PENDUDUK</u></b><br>
				'.$no_surat.'
			</center>
			<br>
        <!-- Begin : Isi Surat -->
        ...
        <div style="margin-top: 10pt; text-align: justify;">
			<span>
                Surat pengantar ini diberikan untuk keperluan '.$fld_layanan.' KTP.
            </span>
        </div>
        <!-- End : Isi Surat -->
