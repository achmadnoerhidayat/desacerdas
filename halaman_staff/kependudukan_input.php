        ...
        <div class="flex">
            ...
            <nav class="side-nav">
                ...
                <ul>
                    ...
                    <li>
                        <a href="side-menu-post.html" class="side-menu side-menu--active">
                    ...
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="post intro-y overflow-hidden box mt-8">
                            <div class="post__tabs nav-tabs flex flex-col sm:flex-row bg-gray-200 text-gray-600">
                                <a title="Fill in the article content" data-toggle="tab" data-target="#content" href="javascript:;" class="tooltip w-full sm:w-50 py-4 text-center flex justify-center items-center active">  Data Diri </a>
                                <a title="Adjust the meta title" data-toggle="tab" data-target="#meta-title" href="javascript:;" class="tooltip w-full sm:w-50 py-4 text-center flex justify-center items-center"> Informasi Menetap Mutasi </a>
                                <a title="Use search keywords" data-toggle="tab" data-target="#keywords" href="javascript:;" class="tooltip w-full sm:w-50 py-4 text-center flex justify-center items-center">  Kepemilikan E-KTP dan Dokumen </a>
                                <a title="Use search keywords" data-toggle="tab" data-target="#keywords1" href="javascript:;" class="tooltip w-full sm:w-50 py-4 text-center flex justify-center items-center">  Data Keluarga </a>
                            </div>
                            <div class="post__content tab-content">
								<div class="tab-content__pane p-5 active" id="content">
									<div class="preview">
										...
										<div class="mt-3">
											<div class="relative mt-2">
												<input class="datepicker input pr-12 w-full border col-span-4" id="txttgllahir" name="txtgllahir" required>
											</div>
										</div>
										<div class="mt-3">
