<?php
	...
	$cari_kd=mysqli_query($koneksi,"SELECT 
									...
									nama, nik, tempat_lhr, DATE_FORMAT(tgl_lhr,'%d %M %Y') AS tanggal_lahir, id_jk, 
									kd_pekerjaan, alamat, 
									fld_kegunaan, DATE_FORMAT(tgl_acara,'%d %M %Y') AS tanggal_acara, fld_tempat, fld_hiburan, 
...
// === Data Izin ===========
	$fld_kegunaan=$tm_cari['fld_kegunaan'];	
	$tanggal_acara=$tm_cari['tanggal_acara'];	
	$fld_tempat=$tm_cari['fld_tempat'];	
	$fld_hiburan=$tm_cari['fld_hiburan'];	
	$fld_nm_babinkamtibmas=$tm_cari['fld_nm_babinkamtibmas'];
	$fld_jbt_babinkamtibmas=$tm_cari['fld_jbt_babinkamtibmas'];	
...
// === Header ==============									
	$cari_kd=mysqli_query($koneksi,"SELECT 
									...
									WHERE id_kel='$kd_kel' and id_kategori='22'");
	$tm_cari=mysqli_fetch_array($cari_kd);
	...
	$html = '<head>
			...
			<div style="text-align: center; margin: 30pt 0;">
				<div style="text-decoration: underline; font-weight: bold;">SURAT IZIN KERAMAIAN</div>		
				<div>'.$no_surat.'</div>				
			</div>

        <!-- Begin : Isi Surat -->
        <div style="margin-top: 10pt;">Yang bertanda tangan di bawah ini, '.$jabatan.' '.$fld_nama_kel.', '.$fld_nama_kec.' dengan ini menerangkan  :</div>
        ...
        <div style="margin-top: 10pt;">Bersama ini kami mohon untuk diterbitkan Surat Izin Keramaian untuk yang bersangkutan sebagai keperluan '.$fld_kegunaan.', yang akan dilaksanakan pada :</div>
        <table style="margin: 10pt 0 10pt 30pt; width: 100%;">
            <tbody>
                <tr>
                ...
                <tr>
                    ...
                    <td style="padding: 1pt 2pt; vertical-align:top; width: 1%;">:</td>
                    <td style="padding: 1pt 2pt; vertical-align:top; width: 65%;">'.$tanggal_acara.'</td>
                </tr>
                <tr>
                    <td style="padding: 1pt 2pt; vertical-align:top; width: 34%;">Tempat</td>
                    <td style="padding: 1pt 2pt; vertical-align:top; width: 1%;">:</td>
                    <td style="padding: 1pt 2pt; vertical-align:top; width: 65%;">'.$fld_tempat.'</td>
                </tr>
                <tr>
                    <td style="padding: 1pt 2pt; vertical-align:top; width: 34%;">Hiburan</td>
                    <td style="padding: 1pt 2pt; vertical-align:top; width: 1%;">:</td>
                    <td style="padding: 1pt 2pt; vertical-align:top; width: 65%;">'.$fld_hiburan.'</td>
                </tr>
            </tbody>
        </table>
        <!-- End : Isi Surat -->
...
$dompdf->stream('surat_izin_keramaian.pdf',array("Attachment"=>0));
?>
