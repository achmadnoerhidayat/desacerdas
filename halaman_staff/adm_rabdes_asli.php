                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box p-5">
                                        ...
                                        <table class="table">
                                            <tbody>
											<form action="adm_rabdes_detail.php" name="modal_popup" enctype="multipart/form-data" method="POST">
												<tr class="">
													<td width="30%" class="no-border">
<select class="input pr-12 w-full border col-span-4" id="cbothn" name="cbothn" required>
																	<option value="">Pilih Tahun</option>
																	<?php
																		$sql="select tahun FROM tbrapbes where kode='$kd_kel' order by tahun desc";
													...
													<td width="20%" class="no-border text-center">
														<button type="submit" name="tambah" class="button w-40 bg-theme-1 text-white">TAMPILKAN</button>
													</td>
