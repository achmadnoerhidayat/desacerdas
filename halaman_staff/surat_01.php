...
session_start();
	...
	if(isset($_POST['btntutup'])) {		
        header('location:pengaturan_surat.php');
	}
?>
...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="index.php" class="">Home</a> 
					...
					<a href="" class="breadcrumb--active">Pengaturan Layanan Surat</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                    ...
                    <div class="intro-y col-span-12 lg:col-span-12">
                        <!-- BEGIN: Input -->
							<div class="intro-y flex items-center h-10">
                                <h3 class="text-lg font-medium truncate mr-5">
                                    Pengaturan Kop Surat Keterangan Domisili
                                </h3>
                            </div>
                        <div class="intro-y box">                            
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">									
									<div class="mt-3">
										<input type="text" class="input w-full border mt-2" value="SURAT KETERANGAN DOMISILI" disabled>
									</div>
									<div class="mt-3">
										<div>
											<label><b>Logo Surat</b></label>
											<input type="file" id="gambar" name="gambar" class="input w-full border mt-2" />
											<label>*Tipe File PNG,JPEG, Ukuran Maksimum 5Mb</label>
										</div>
									</div>
									<div class="mt-3">
										<input type="text" class="input w-full border mt-2" value="<?php echo $nm_kab; ?>" disabled>
									</div>
									<div class="mt-3">
										<input type="text" class="input w-full border mt-2" value="<?php echo $nm_kec; ?>" disabled>
									</div>
									<div class="mt-3">
										<input type="text" class="input w-full border mt-2" value="<?php echo $nm_kel; ?>" disabled>
									</div>									
									<div class="mt-3">
										<input type="text" class="input w-full border mt-2" id="txtalamat" name="txtalamat" 
										autocomplete="off" placeholder="Alamat">
									</div>
									<div class="mt-3">
										<input type="text" class="input w-full border mt-2" id="txttempat" name="txttempat" 
										autocomplete="off" placeholder="Tempat Penerbitan Surat">
									</div>
									<div class="mt-3">
										<input type="text" class="input w-full border mt-2" id="txtjabatan" name="txtjabatan" 
										autocomplete="off" placeholder="Jabatan Penanggung Jawab">
									</div>
									<div class="mt-3">
										<input type="text" class="input w-full border mt-2" id="txtnm" name="txtnm" 
										autocomplete="off" placeholder="Nama Penanggung Jawab">
									</div>									
									<div class="mt-3">
										<input type="text" class="input w-full border mt-2" id="txtnip" name="txtnip" 
										autocomplete="off" placeholder="NIP Penanggung Jawab">
									</div>																		
								</div>
								<div class="p-5" id="icon-button">
									<div class="preview flex flex-wrap">
										<button type="submit" class="button w-32 mr-2 mb-2 flex items-center justify-center bg-theme-6 text-white" id="btntutup" name="btntutup"> <i data-feather="corner-up-left" class="w-4 h-4 mr-2"></i> Kembali </button>									
										<button type="submit" class="button w-32 mr-2 mb-2 flex items-center justify-center bg-theme-1 text-white" id="btnsimpan" name="btnsimpan"> <i data-feather="save" class="w-4 h-4 mr-2"></i> Simpan </button>								
									</div>
								</div>	
							</div>
							</form>
