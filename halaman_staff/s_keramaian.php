...
session_start();
	...
	$data = mysqli_query($koneksi,"SELECT * FROM tbpengaturan_surat WHERE id_kel='$kd_kel' and id_kategori='22'");
	$cek = mysqli_num_rows($data);
	if($cek > 0){	
		$cari_kd=mysqli_query($koneksi,"SELECT id, alamat, tempat, jabatan, nama, nip, no_pengaturan FROM tbpengaturan_surat WHERE id_kel='$kd_kel' and id_kategori='22'");
		$tm_cari=mysqli_fetch_array($cari_kd);
		$nip_jwb=$tm_cari['nip'];
		$nm_jwb=$tm_cari['nama'];
		...
		echo"<script>window.alert('Pengaturan Surat Izin Keramaian Belum Ada. Silahkan Buat Pengaturan Suratnya.');window.location=('pengaturan_surat.php');</script>";		
	}
	...
	if(isset($_POST['btnsimpan'])) {	
		...
		$txttglacara = ubahformatTgl($_POST['date_of_birth1']); 
			
		$cbokel = $_POST['txtkdkel'];
		$txtnama = $_POST['txtnama'];
		$title="SURAT IZIN KERAMAIAN ".$txtnama;	
		...
		$txtkegunaan = $_POST['txtkegunaan'];
		$txttempat = $_POST['txttempat'];		
		$txthiburan = $_POST['txthiburan'];
		$txtnama1 = $_POST['txtnama1'];				
		$txtjbt1 = $_POST['txtjbt1'];		
		...
		$cari_kd=mysqli_query($koneksi,"SELECT count(nomor_surat) as total 
						FROM tbbuatsurat WHERE id_kel='$kd_kel' and id_kategori='22' and 
		...
		mysqli_query($koneksi,"INSERT INTO tbbuatsurat 
							...
							nama, nik, tempat_lhr, tgl_lhr, id_jk, kd_pekerjaan, alamat, 
							fld_kegunaan, tgl_acara, fld_tempat, fld_hiburan, 
							fld_nm_babinkamtibmas, fld_jbt_babinkamtibmas) 
							VALUES 
							('$txtno','$tgl_skr_eng','$title','$cbokel','22',
							'$txtnama','$txtnik','$txttempatlhr','$txttgl','$cbojk','$cbopekerjaan','$txtalamat',
							'$txtkegunaan','$txttglacara','$txttempat','$txthiburan',
							'$txtnama1','$txtjbt1')");
...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="index.php" class="">Home</a> 
    ...
    <div class="flex items-center mt-8 intro-y">
        <h2 class="mr-auto text-lg font-medium">Layanan Surat - Form Buat Surat Izin Keramaian</h2>
    </div>
        ...
        <div class="p-5 mt-2 box intro-y">
            <div class="flex">
                <div class="flex-row items-center w-1/3 mr-2">
                    ...
                    <div class="w-full mt-4">
                        <label class="block mb-2">N I K</label>
...
<textarea class="input w-full border mt-2" id="txtalamat" name="txtalamat" required></textarea>
                ...
                <div class="flex-row items-center w-1/3 mx-2">
                    <div class="w-full pb-3 border-b border-gray-300">
                        <h4 class="mr-auto text-lg font-medium">Data Penggunaan</h4>
                    </div>

                    <div class="w-full mt-4">
                        <label class="block mb-2">Kegunaan Untuk</label>
                        <input type="text" class="input w-full border mt-2" id="txtkegunaan" name="txtkegunaan" autocomplete="off" required>
                    </div>
                    ...
                    <div class="w-full mt-4">
                        <label class="block mb-2">Tempat</label>
                        <input type="text" class="input w-full border mt-2" id="txttempat" name="txttempat" autocomplete="off" required>
                    </div>

                    <div class="w-full mt-4">
                        <label class="block mb-2">Hiburan</label>
                       <input type="text" class="input w-full border mt-2" id="txthiburan" name="txthiburan" autocomplete="off" required>
                    </div>
                </div>

                <div class="flex-row items-center w-1/3 ml-2">
                    <div class="w-full pb-3 border-b border-gray-300">
                        <h4 class="mr-auto text-lg font-medium">Data Babinkamtibmas</h4>
                    </div>
                    ...
                    <div class="w-full mt-4">
                        ...
                        <input type="text" class="input w-full border mt-2" id="txtjbt1" name="txtjbt1" autocomplete="off" required>
                    </div>
...
function popUp(){
	if (wi) wi.close();
		...
		var _txt8 = $("#date_of_birth1").val();
		var _txt9 = $("#txtkegunaan").val();
		var _txt10 = $("#txttempat").val();
		var _txt11 = $("#txthiburan").val();
		var _txt12 = $("#txtnama1").val();
		var _txt13 = $("#txtjbt1").val();		
		...
		wi=window.open("s_keramaian_preview.php" + queryString,"","width=700,height=600,location=no,scrollbars=no,status=no");
}
//-->
</script>
