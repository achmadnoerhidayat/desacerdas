<?php
	...
	$cari_kd=mysqli_query($koneksi,"SELECT 
									...
									nama_pasutri, DATE_FORMAT(tgl_cerai,'%d %M %Y') AS tanggal_cerai, fld_umur1 
									FROM tbbuatsurat 
...
// === Data Warga 1 ===========
	...
	$txtumur=$tm_cari['fld_umur1'];		
	
// === Keterangan Surat ===========	
	$tanggal_cerai=$tm_cari['tanggal_cerai'];
	$nama_mantan=$tm_cari['nama_pasutri'];	
