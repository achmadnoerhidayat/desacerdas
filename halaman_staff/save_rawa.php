<?php 
    ...
    //if ($size < 5000000 and ($type =='image/jpeg' or $type =='image/jpg' or $type == 'image/png')) {
        move_uploaded_file($temp, $folder . $name);
			mysqli_query($koneksi,"INSERT INTO tbrawa 
				(kode, nama_rawa, luas, kedalaman, kondisi, pemanfaatan, tgl_input, jam_input, user_id, file_photo, file_name) 
				VALUES 
				('$cbokel','$txtnm','$txtluas','$txtdalam','$cbokondisi','$txtpotensi',
				'$tgl_skr','$waktuaja_skr','','$foto','$name')");
        header('location:rawa.php');
    //}else{
