...
session_start();
	...
	$data = mysqli_query($koneksi,"SELECT * FROM tbpengaturan_surat WHERE id_kel='$kd_kel' and id_kategori='10'");
	$cek = mysqli_num_rows($data);
	if($cek > 0){	
		$cari_kd=mysqli_query($koneksi,"SELECT id, alamat, tempat, jabatan, nama, nip, no_pengaturan FROM tbpengaturan_surat WHERE id_kel='$kd_kel' and id_kategori='10'");
		$tm_cari=mysqli_fetch_array($cari_kd);
		$nip_jwb=$tm_cari['nip'];
		$nm_jwb=$tm_cari['nama'];
		...
		echo"<script>window.alert('Pengaturan Surat Keterangan Gugat Cerai Belum ada. Silahkan Buat Pengaturan Suratnya.');window.location=('pengaturan_surat.php');</script>";		
	}
	...
	if(isset($_POST['btnsimpan'])) {	
		...
		$txttglgugat = ubahformatTgl($_POST['date_of_birth2']);
			
		$cbokel = $_POST['txtkdkel'];
		$txtnama = $_POST['txtnama'];
		$title="SURAT KETERANGAN GUGAT CERAI ".$txtnama;		
		...
		$txtnik1 = $_POST['txtnik1'];
		$txttempatlhr1 = $_POST['txttempatlhr1'];
		$cbojk1 = $_POST['cbojk1'];
		$cboagama1 = $_POST['cboagama1'];
		$cbopekerjaan1 = $_POST['cbopekerjaan1'];
		$txtalamat1 = $_POST['txtalamat1'];		
		$txtumur1 = $_POST['txtumur1'];		
		
		$txthari = $_POST['txthari'];	
		$txtsaksi1 = $_POST['txtsaksi1'];		
		$txtsaksi2 = $_POST['txtsaksi2'];
		...
		mysqli_query($koneksi,"INSERT INTO tbbuatsurat 
							...
							nama, nik, tempat_lhr, tgl_lhr, id_jk, id_agama, kd_pekerjaan, alamat, fld_umur1, 
							nama1, nik1, tempat_lhr1, tgl_lhr1, id_jk1, id_agama1, kd_pekerjaan1, alamat1, fld_umur2, 
							tgl_gugat, fld_hari, fld_saksi1, fld_saksi2) 
							VALUES 
							('$txtno','$tgl_skr_eng','$title','$cbokel','10',
							'$txtnama','$txtnik','$txttempatlhr','$txttgl','$cbojk','$cboagama','$cbopekerjaan','$txtalamat','$txtumur',
							'$txtnama1','$txtnik1','$txttempatlhr1','$txttgl1','$cbojk1','$cboagama1','$cbopekerjaan1','$txtalamat1','$txtumur1',
							'$txttglgugat','$txthari','$txtsaksi1','$txtsaksi2')");	
...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="index.php" class="">Home</a> 
    ...
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">Layanan Surat - Form Buat Surat Keterangan Gugat Cerai</h2>
    </div>
            ...
            <div class="flex">
                <div class="flex-row items-center w-1/3 mr-2">
                    <div class="w-full border-b border-gray-300 pb-3">
                        <h4 class="text-lg font-medium mr-auto">Biodata Pihak 1</h4>
                    </div>
...
<textarea class="input w-full border mt-2" id="txtalamat" name="txtalamat" required></textarea>
                ...
                <div class="flex-row items-center w-1/3 mx-2">
                    <div class="w-full border-b border-gray-300 pb-3">
                        <h4 class="text-lg font-medium mr-auto">Biodata Pihak 2</h4>
                    </div>
                    ...
                    <div class="w-full mt-4">
                        <label class="mb-2 block">NIK</label>
                        <input type="text" class="input w-full border mt-2" id="txtnik1" name="txtnik1" autocomplete="off" required>
                    </div>
                    ...
                    <div class="w-full mt-4">
                        ...
                        <div class="flex">
                            <div class="mr-2">
                                <input type="text" class="input w-full border mt-2" id="txttempatlhr1" name="txttempatlhr1" autocomplete="off" required>
                            </div>
                            <div class="ml-2">
<input name="date_of_birth1" id="date_of_birth1" class="datepicker input w-full border block mx-auto" data-single-mode="true" >
                    ...
                    <div class="w-full mt-4">
                        <label class="mb-2 block">Jenis Kelamin</label>
                        <select class="input pr-12 w-full border col-span-4" name="cbojk1" id="cbojk1" required>
										<?php
											$sql="select kode, jk FROM tbjk";
											$sql_row=mysqli_query($koneksi,$sql);
											while($sql_res=mysqli_fetch_assoc($sql_row))	
                    ...
                    <div class="w-full mt-4">
                        <label class="mb-2 block">Agama</label>
                        <select class="input pr-12 w-full border col-span-4" id="cboagama1" name="cboagama1" required>
									<?php
										$sql="select kode, agama FROM tbagama";
										$sql_row=mysqli_query($koneksi,$sql);
										while($sql_res=mysqli_fetch_assoc($sql_row))	
...
<textarea class="input w-full border mt-2" id="txtalamat1" name="txtalamat1" required></textarea>
                ...
                <div class="flex-row items-center w-1/3 ml-2">
                    <div class="w-full border-b border-gray-300 pb-3">
                        <h4 class="text-lg font-medium mr-auto">Data Gugatan</h4>
                    </div>

                    <div class="w-full mt-4">
                        <label class="mb-2 block">Hari/Tanggal</label>
                        <div class="flex">
                            <div class="mr-2">
                                <input type="text" class="input w-full border mt-2" id="txthari" name="txthari" autocomplete="off" required>
                            </div>
                            <div class="ml-2">
<input name="date_of_birth2" id="date_of_birth2" class="datepicker input w-full border block mx-auto" data-single-mode="true" >
                    ...
                    <div class="w-full border-b border-gray-300 pb-3 mt-4">
                        <h4 class="text-lg font-medium mr-auto">Saksi - Saksi</h4>
                    </div>

                    <div class="w-full mt-4">
                        <label class="mb-2 block">Nama Lengkap Saksi 1</label>
                        <input type="text" class="input w-full border mt-2" id="txtsaksi1" name="txtsaksi1" autocomplete="off" required>
                    </div>

                    <div class="w-full mt-4">
                        <label class="mb-2 block">Nama Lengkap Saksi 2</label>
                        <input type="text" class="input w-full border mt-2" id="txtsaksi2" name="txtsaksi2" autocomplete="off" required>
                    </div>
                </div>
            </div>
...
function popUp(){
	if (wi) wi.close();
		...
		var _txt10 = $("#txtnama1").val();
		var _txt11 = $("#txtnik1").val();		
		var _txt12 = $("#txttempatlhr1").val();
		var _txt13 = $("#date_of_birth1").val();
		var _txt14 = $("#cbojk1").val();
		var _txt15 = $("#cboagama1").val();
		var _txt16 = $("#cbopekerjaan1").val();
		var _txt17 = $("#txtalamat1").val();
		var _txt18 = $("#txtumur1").val();

		var _txt19 = $("#date_of_birth2").val();
		var _txt20 = $("#txthari").val();
		var _txt21 = $("#txtsaksi1").val();
		var _txt22 = $("#txtsaksi2").val();		
	
		var queryString = "?txt1=" + _txt1 + "&txt2=" + _txt2 + "&txt3=" + _txt3 + "&txt4=" + _txt4 + "&txt5=" + _txt5 + "&txt6=" + _txt6 + "&txt7=" + _txt7 + "&txt8=" + _txt8 + "&txt9=" + _txt9 + "&txt10=" + _txt10 + "&txt11=" + _txt11 + "&txt12=" + _txt12 + "&txt13=" + _txt13 + "&txt14=" + _txt14 + "&txt15=" + _txt15 + "&txt16=" + _txt16 + "&txt17=" + _txt17 + "&txt18=" + _txt18 + "&txt19=" + _txt19 + "&txt20=" + _txt20 + "&txt21=" + _txt21 + "&txt22=" + _txt22;
		wi=window.open("s_gugat_cerai_preview.php" + queryString,"","width=700,height=600,location=no,scrollbars=no,status=no");
}
//-->
</script>
