<?php
	...
	$cari_kd=mysqli_query($koneksi,"SELECT 
									...
									kd_pekerjaan, alamat, 
									fld_kegunaan, DATE_FORMAT(tgl_acara,'%d %M %Y') AS tanggal_acara, fld_tempat	
									FROM tbbuatsurat 
...
// === Header ==============									
	$cari_kd=mysqli_query($koneksi,"SELECT 
									...
									WHERE id_kel='$kd_kel' and id_kategori='24'");
	$tm_cari=mysqli_fetch_array($cari_kd);
	...
	$html = '<head>
			...
			<div style="text-align: center; margin: 30pt 0;">
				<div style="text-decoration: underline; font-weight: bold;">SURAT IZIN MINTA SUMBANGAN</div>		
				<div>'.$no_surat.'</div>				
			</div>
        ...
        <div style="margin-top: 10pt; text-align: justify; text-indent: 30pt;">
			<span>
                Bersama ini kami mohon untuk diterbitkan Surat Izin Minta Sumbangan untuk yang bersangkutan sebagai keperluan '.$fld_kegunaan.', yang akan dilaksanakan pada :
            </span>
        </div>
...
$dompdf->stream('surat_izin_sumbangan.pdf',array("Attachment"=>0));
?>
