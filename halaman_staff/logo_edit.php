...
<?php include "menu_profil01.php"; ?>
            ...
            <div class="content">
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="index.php" class="">Home</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="validasi_desa.php" class="breadcrumb--active">Validasi Desa-Edit Logo</a> </div>
                    <!-- END: Breadcrumb -->
    ...
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">Edit Logo</h2>
    </div>
