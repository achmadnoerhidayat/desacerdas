...
tbpengurus_rt.id_rt, tbpengurus_rt.nama, tbpengurus_rt.id, tbpengurus_rt.id_jabatan, tbpengurus_rt.file_photo, tbpengurus_rt.file_name, 
tbrt.rt, tbdukuh.nm_dukuh  
FROM tbpengurus_rt,tbrt,tbrw,tbdukuh 
WHERE tbpengurus_rt.id_rt=tbrt.id_rt and 
tbrt.id_rw=tbrw.id and 
tbrw.id_dukuh=tbdukuh.id_dukuh and 
...
tbdukuh.kode='$kd_kel' LIMIT $mulai, $halaman")or die(mysql_error);
												...
												while ($data = mysqli_fetch_assoc($query)) {
													...
													$photo_pengurus=$data['file_photo'];
...
<a href="javascript:void(0);" onClick="newPopup('peta_detail.php?img=<?php echo $photo_pengurus; ?>');">Lihat Photo</a>
															</td>															
															<td class="border-b text-center">
