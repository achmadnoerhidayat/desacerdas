...
session_start();
	...
	$data = mysqli_query($koneksi,"SELECT * FROM tbpengaturan_surat WHERE id_kel='$kd_kel' and id_kategori='19'");
	...
	if($cek > 0){	
		...
		echo"<script>window.alert('Pengaturan Surat Pengantar SKCK Belum Ada. Silahkan Buat Pengaturan Suratnya.');window.location=('pengaturan_surat.php');</script>";		
	}
	...
	if(isset($_POST['btnsimpan'])) {	
		...
		$title="SURAT PENGANTAR SKCK ".$txtnama;
		...
		mysqli_query($koneksi,"INSERT INTO tbbuatsurat 
							...
							'$txttgl','$cbopekerjaan','$txtalamat','$cbokel','19', '$cbostatus', '$cboagama',
							'$txtwarga')");	
...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="index.php" class="">Home</a> 
    ...
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">Layanan Surat - Form Buat Surat Pengantar SKCK</h2>
    </div>
                ...
                <div class="flex-row items-center w-1/3 mr-2">
                    ...
                    <div class="w-full mt-4">
                        <label class="mb-2 block">Kewarganegaraan</label>
                            <input type="text" class="input w-full border mt-2" id="txtwarga" name="txtwarga" autocomplete="off" required>
                    </div>
                    ...
                    <div class="w-full mt-4">
                        <label class="mb-2 block">Status Perkawinan</label>
...
function popUp(){
	if (wi) wi.close();
		...
		var queryString = "?txt1=" + _txt1 + "&txt4=" + _txt4 + "&txt5=" + _txt5 + "&txt6=" + _txt6 + "&txt7=" + _txt7 + "&txt8=" + _txt8 + "&txt9=" + _txt9 + "&txt10=" + _txt10 + "&txt11=" + _txt11 + "&txt12=" + _txt12;
		wi=window.open("s_skck_preview.php" + queryString,"","width=700,height=600,location=no,scrollbars=no,status=no");
}
//-->
</script>
