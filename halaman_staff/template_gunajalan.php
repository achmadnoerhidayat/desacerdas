...
// === Header ==============									
	$cari_kd=mysqli_query($koneksi,"SELECT 
									...
									WHERE id_kel='$kd_kel' and id_kategori='26'");
	$tm_cari=mysqli_fetch_array($cari_kd);
	...
	$html = '<head>
			...
			<div style="text-align: center; margin: 30pt 0;">
				<div style="text-decoration: underline; font-weight: bold;">SURAT IZIN GUNA JALAN</div>		
				<div>'.$no_surat.'</div>				
			</div>
        ...
        <div style="margin-top: 10pt;">Bersama ini kami mohon untuk diterbitkan Surat Izin Guna Jalan untuk yang bersangkutan sebagai keperluan '.$fld_kegunaan.', yang akan dilaksanakan pada :</div>
        <table style="margin: 10pt 0 10pt 30pt; width: 100%;">
            <tbody>
                <tr>
...
//$dompdf->stream('surat_izin_gunalahan.pdf');
$dompdf->stream('surat_izin_gunajalan.pdf',array("Attachment"=>0));
?>
