...
<?php include "menu_ujian.php"; ?>
    ...
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">Ujian / Sertifikasi</h2>
        <a href="tabel_score.php" class="button border border-theme-1 text-theme-1 ml-auto">
            Tabel Hasil
        </a>
    </div>
                ...
                <div class="intro-y box">
                    <div class="flex flex-row items-center p-5 lg:p-10">
                        ...
                        <div class="w-1/3 lg:w-1/2 text-right">
							<?php 
								$data = mysqli_query($koneksi,"SELECT * FROM tbujian WHERE id_modul='$id_modul' and nik='$nip'");
								$cek = mysqli_num_rows($data);
								if($cek > 0){
									$cari_kd=mysqli_query($koneksi,"SELECT status FROM tbujian WHERE id_modul='$id_modul' and nik='$nip'");
									$tm_cari=mysqli_fetch_array($cari_kd);
									$status_ujian=$tm_cari['status'];
									
									if($status_ujian=='') {
							?>
								<span class="button w-auto inline-block mr-1 mb-2 border border-theme-33 text-theme-33 cursor-default">
									Sedang di Periksa
								</span>
							<?php
									} else {
							...
							?>
								<span class="button w-auto inline-block mr-1 mb-2 border bg-theme-9 text-white cursor-default">
									Sudah Lulus
								</span>							
							<?php
										} else {
							?>
								<a href="" class="button w-auto inline-block mr-1 mb-2 border border-theme-6 text-theme-6">
									Ikut Ulangan
								</a>
							<?php
										}
							...
							?>
                                    <a href="ujian_next.php?idmodul=<?php echo $id_modul; ?>" class="button w-auto inline-block mr-1 mb-2 border border-theme-1 text-theme-1">
                                        Kerjakan Soal
                                    </a>
							<?php
								}
