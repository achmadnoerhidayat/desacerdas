...
<body>
	...
	header("Content-Disposition: attachment; filename=Data KTP dan KK.xls");
	?>
	...
	<table border="1">
		...
		<tr>
														...
														<td class="border text-center"><font size="2"><?php echo $d['kk']; ?></font></td>
														<td class="border text-center"><font size="2"><?php echo $d['nama']; ?></font></td>          
														<td class="border text-center"><font size="2"><?php echo $d['nik']; ?></font></td>														
														...
														<td class="border text-center"><font size="2"><?php echo $d['alamat']; ?></font></td>
														<td class="border text-center"><font size="2"><?php echo $status_nikah; ?></font></td>
														<td class="border text-center">
															<font size="2">
															<?php echo $d['ktp_ket1']; ?>/<?php echo $d['ktp_ket2']; ?>
															</font>
														</td>														
														<td class="border text-center"><font size="2"><?php echo $d['status_hub']; ?></font></td>
														<td class="border text-center"><font size="2"><?php echo $warga; ?></font></td>
														<td class="border text-center"><font size="2"><?php echo $d['nm_ayah']; ?></font></td>
														<td class="border text-center"><font size="2"><?php echo $d['nm_ibu']; ?></font></td>													
