...
<body>
	...
	<table border="1" cellspacing="0" style="width: 100%">
		...
		$sql = mysqli_query($koneksi,"select *, 
								DATE_FORMAT(tgl_lhr,'%d/%m/%Y') AS tanggal, 
								...
								FROM tbpenduduk where kode='$kd_kel' and (menetap<>'Menetap' and menetap<>'Lahir Di' and menetap<>'Hilang')
								and month(tgl_register)='$sbln' and year(tgl_register)='$sthn'");
		...
		<tr>
														...
														<td align="center"><font size="2"><?php echo $txttgldatang; ?></font></td>														
														<td align="center"><font size="2"><?php echo $data['menetap_ket3']; ?></font></td>
														<td align="center"><font size="2"><?php echo $txttglpindah; ?></font></td>
														<td align="center"><font size="2"><?php echo $data['menetap_ket4']; ?></font></td>
														<td align="center"><font size="2"><?php echo $txttglmati; ?></font></td>														
