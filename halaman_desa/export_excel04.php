...
<body>
	...
	header("Content-Disposition: attachment; filename=Data Kependudukan Berdasarkan Agama.xls");
	?>

	<center>
		<h4>Data Kependudukan Berdasarkan Agama</h4>
	</center>
	...
	<table border="1">
		<tr>
			...
			<td align="center" bgcolor="yellow"><font size="2">Agama</font></td>
...
$kd_pekerjaan=$d['kd_pekerjaan'];
	...
	$cari_kd=mysqli_query($koneksi,"select pekerjaan FROM tbpekerjaan where kode='$kd_pekerjaan'");
		...
		<tr>
			...
			<td align="center" bgcolor="yellow"><font size="2"><?php echo $agama; ?></font></td>
