...
session_start();
	...
	$cari_kd=mysqli_query($koneksi,"SELECT 
					tgl, DATE_FORMAT(tgl,'%d/%m/%Y') AS tanggal, suspect, probable, positif, perawatan, meninggal, sembuh, otg, isoman  
...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="index.php" class="">Home</a> 
					...
					<a href="covid_update.php" class="">Covid 19</a>
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									...
									<div class="mt-3">
															<label><b>OTG</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txt7" name="txt7" value="<?php echo $txt7; ?>" autocomplete="off" required placeholder="OTG">
                                    </div>
									<div class="mt-3">
															<label><b>Isoman</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txt8" name="txt8" value="<?php echo $txt8; ?>" autocomplete="off" required placeholder="Isoman">
                                    </div>
