...
session_start();
	...
	$data = mysqli_query($koneksi,"SELECT * FROM tbpengaturan_surat WHERE id_kel='$kd_kel' and id_kategori='14'");
	$cek = mysqli_num_rows($data);
	if($cek > 0){	
		$cari_kd=mysqli_query($koneksi,"SELECT id, alamat, tempat, jabatan, nama, nip, no_pengaturan FROM tbpengaturan_surat WHERE id_kel='$kd_kel' and id_kategori='14'");
		$tm_cari=mysqli_fetch_array($cari_kd);
		$nip_jwb=$tm_cari['nip'];
		$nm_jwb=$tm_cari['nama'];
		...
		echo"<script>window.alert('Pengaturan Surat Keterangan Kelahiran Belum ada. Silahkan Buat Pengaturan Suratnya.');window.location=('pengaturan_surat.php');</script>";		
	}
	...
	if(isset($_POST['btnsimpan'])) {	
		...
		$title="SURAT KETERANGAN KELAHIRAN ".$txtnama;		
		...
		$txtnik2 = $_POST['txtnik2'];
		$cbopekerjaan2 = $_POST['cbopekerjaan2'];
		$txtalamat2 = $_POST['txtalamat2'];		
		$txtumur2 = $_POST['txtumur2'];		

		$txtjamlhr = $_POST['txtjamlhr'];
		...
		mysqli_query($koneksi,"INSERT INTO tbbuatsurat 
							...
							nama, tempat_lhr, tgl_lhr, id_jk, 
							nama1, nik1, kd_pekerjaan1, alamat1, fld_umur1,
							nama2, nik2, kd_pekerjaan2, alamat2, fld_umur2,							
							fld_jamlahir) 
							VALUES 
							('$txtno','$tgl_skr_eng','$title','$cbokel','14',
							'$txtnama','$txttempatlhr','$txttgl','$cbojk',
							'$txtnama1','$txtnik1','$cbopekerjaan1','$txtalamat1','$txtumur1',
							'$txtnama2','$txtnik2','$cbopekerjaan2','$txtalamat2','$txtumur2',							
							'$txtjamlhr')");	
...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="index.php" class="">Home</a> 
			...
			<div class="intro-y flex items-center mt-8">
				<h2 class="text-lg font-medium mr-auto">Layanan Surat - Form Buat Surat Keterangan Kelahiran</h2>
			</div>
            ...
            <div class="flex">
                <div class="flex-row items-center w-1/3 mr-2">
                    <div class="w-full pb-3 border-b border-gray-300">
                        <h4 class="mr-auto text-lg font-medium">Biodata Bayi</h4>
                    </div>
                    ...
                    <div class="flex mt-4">
                        <div class="w-1/3 mr-2">
                            <label class="block mb-2">Jam Lahir</label>
							<input type="text" class="input w-full border mt-2" id="txtjamlhr" name="txtjamlhr" autocomplete="off" required placeholder="10:00 wib">
                        </div>
...
<input name="date_of_birth" id="date_of_birth" class="datepicker input w-full border block mx-auto" data-single-mode="true" >
                ...
                <div class="flex-row items-center w-1/3 mx-2">
                    <div class="w-full pb-3 border-b border-gray-300">
                        <h4 class="mr-auto text-lg font-medium">Biodata Ayah</h4>
                    </div>
...
<textarea class="input w-full border mt-2" id="txtalamat1" name="txtalamat1" required></textarea>
                ...
                <div class="flex-row items-center w-1/3 ml-2">
                    <div class="w-full pb-3 border-b border-gray-300">
                        <h4 class="mr-auto text-lg font-medium">Biodata Ibu</h4>
                    </div>

                    <div class="w-full mt-4">
                        <label class="block mb-2">Nama Lengkap</label>
                        <input type="text" class="input w-full border mt-2" id="txtnama2" name="txtnama2" autocomplete="off" required>
                    </div>

                    <div class="w-full mt-4">
                        <label class="block mb-2">NIK</label>
                        <input type="text" class="input w-full border mt-2" id="txtnik2" name="txtnik2" autocomplete="off" required>
                    </div>

                    <div class="w-full mt-4">
                        <label class="block mb-2">Umur</label>
                        <input type="text" class="input w-full border mt-2" id="txtumur2" name="txtumur2" autocomplete="off" required>
                    </div>

                    <div class="w-full mt-4">
                        <label class="block mb-2">Pekerjaan</label>
                        <select class="input pr-12 w-full border col-span-4" name="cbopekerjaan2" id="cbopekerjaan2" required>
											<?php
																	$sql="select kode, pekerjaan FROM tbpekerjaan";
			       														$sql_row=mysqli_query($koneksi,$sql);
			       														while($sql_res=mysqli_fetch_assoc($sql_row))	
                    ...
                    <div class="w-full mt-4">
                        <label class="block mb-2">Alamat</label>
<textarea class="input w-full border mt-2" id="txtalamat2" name="txtalamat2" required></textarea>
                    </div>
...
function popUp(){
	if (wi) wi.close();
		...
		var _txt5 = $("#txtnama1").val();
		var _txt6 = $("#txtnik1").val();
		var _txt7 = $("#cbopekerjaan1").val();
		var _txt8 = $("#txtalamat1").val();
		var _txt9 = $("#txtumur1").val();

		var _txt10 = $("#txtnama2").val();
		var _txt11 = $("#txtnik2").val();
		var _txt12 = $("#cbopekerjaan2").val();
		var _txt13 = $("#txtalamat2").val();
		var _txt14 = $("#txtumur2").val();
		
		var _txt15 = $("#txtjamlhr").val();
		...
		wi=window.open("s_kelahiran_preview.php" + queryString,"","width=700,height=600,location=no,scrollbars=no,status=no");
}
//-->
</script>
