...
<?php include "menu_sampah02.php"; ?>
            ...
            <div class="content">
                ...
                <div class="top-bar">
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="tps.php" class="breadcrumb--active">Data TPS</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
										...
										<table class="table table--sm" width="100%"> 
											...
											<?php 
												...
												$mulai = ($page>1) ? ($page * $halaman) - $halaman : 0;
														...
														$result = mysqli_query($koneksi,"SELECT * FROM tbtps where kode='$kd_kel' and nm_tps like '%$varsearch%'");
												...
												$pages = ceil($total/$halaman);            
														...
														$query = mysqli_query($koneksi,"SELECT * FROM tbtps where kode='$kd_kel' and nm_tps like '%$varsearch%' LIMIT $mulai, $halaman")or die(mysql_error);												
