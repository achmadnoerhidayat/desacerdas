...
session_start();
	...
	if(isset($_POST['btnsimpan'])) {	
		...
		mysqli_query($koneksi,"UPDATE tbmodul_ass SET nama_paket='$txtkode', deskripsi='$txtdeskripsi', waktu='$txtwaktu' WHERE id_modul='$txtid'");
		echo"<script>window.alert('Data Berhasil Disimpan!');window.location=('ass_manajemen.php');</script>";		
	}	
?>
...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="index.php" class="">Home</a> 
					...
					<a href="" class="breadcrumb--active">Assesment</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
								...
								<div class="p-5 grid grid-cols-12 gap-4 gap-y-3">
									<div class="col-span-12">
										<div>
											...
											<input name="assesment-category" type="text" class="input w-full border mt-2 flex-1" value="<?php echo $nama_paket; ?>">
										</div>

										<div class="mt-5">
											<label>Deskripsi Singkat</label>
											<textarea name="assesment-description" class="input w-full border mt-2 flex-1" cols="10"><?php echo $deskripsi; ?></textarea>
										</div>

										<div class="mt-3">
											<label>Waktu Pengerjaan</label>
											<input name="assesment-time" type="number" step="5" class="input w-full border mt-2 flex-1" value="<?php echo $waktu; ?>">
										</div>
									</div>
								</div>
								<div class="px-5 py-3 text-right border-t border-gray-200 dark:border-dark-5">
									<button type="submit" id="btntutup" name="btntutup" 
									class="button w-32 border text-gray-700 dark:border-dark-5 dark:text-gray-300 mr-1">
										Batal
									</button>
									<button type="submit" id="btnsimpan" name="btnsimpan" class="button w-32 bg-theme-1 text-white">
										Simpan
									</button>
								</div>
							</form>
