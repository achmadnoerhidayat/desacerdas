<?php
	...
	$id_jk=$_GET['txt4'];
	$id_agama=$_GET['txt5'];
	$id_status_kawin=$_GET['txt6'];
	$kd_pekerjaan=$_GET['txt7'];	
	$alamat=$_GET['txt8'];		
	$fld_keperluan=$_GET['txt9'];
	$tgl_surat="";
	...
	$cari_kd=mysqli_query($koneksi,"SELECT 
									...
									WHERE id_kel='$kd_kel' and id_kategori='18'");
	$tm_cari=mysqli_fetch_array($cari_kd);
	...
	$html = '<table width="100%">
			...
			<br>
			<center>
				<b><u>SURAT PENGANTAR AKTE KELAHIRAN</u></b><br>
				'.$no_surat.'
			</center>
			<br>
        <!-- Begin : Isi Surat -->
        ...
        <div style="margin-top: 10pt; text-align: justify;">
			<span>
                Surat pengantar ini diberikan untuk keperluan '.$fld_keperluan.' Akta Kelahiran.			
            </span>
        </div>
        <!-- End : Isi Surat -->
