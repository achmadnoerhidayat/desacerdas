											...
											<form action="" name="modal_popup" enctype="multipart/form-data" method="POST">
												<tr class="">
													<td width="60%" class="no-border">
														...
														placeholder="Nama/Paket Ujian" id="txtcari" name="txtcari">               
													</td>
													<td width="20%" class="no-border">
														<input class="input pr-12 w-full border col-span-4" 
														placeholder="Tanggal Ujian" id="txttglcari" name="txttglcari">               
													</td>
												...
												if(isset($_POST['tambah'])){	
													...
													if ($txtcari<>'') {
														$result = mysqli_query($koneksi,"SELECT * FROM vw_ujian WHERE id_kel='$kd_kel' and 
																						(nama like '%$txtcari%' or nama_paket like '%$txtcari%') and 
																						status='Lulus'");
													}
													if ($txtcari=='') {
														$result = mysqli_query($koneksi,"SELECT * FROM vw_ujian WHERE id_kel='$kd_kel' and 
											...
											?>
												<tbody>
													<tr>
														...
														<td class="border text-center"><font color="green"><?php echo $data['status']?></font></td>														
															...
															<div class="dropdown relative">
																...
																<div class="dropdown-box mt-10 absolute w-40 top-0 right-0 z-20">
																	<div class="dropdown-box__content box p-2">
																		...
																		<a href="ass_hasil_lulus.php" class="flex items-center block p-2 transition duration-300 ease-in-out bg-white hover:bg-gray-200 rounded-md"> <i data-feather="check" class="w-4 h-4 mr-2"></i> Lulus </a>
																		<a href="ass_hasil_gagal.php" class="flex items-center block p-2 transition duration-300 ease-in-out bg-white hover:bg-gray-200 rounded-md"> <i data-feather="x" class="w-4 h-4 mr-2"></i> Tidak Lulus </a>
																	</div>
																</div>
															</div>
															</center>
