...
session_start();
	...
	$data = mysqli_query($koneksi,"SELECT * FROM tbpengaturan_surat WHERE id_kel='$kd_kel' and id_kategori='15'");
	$cek = mysqli_num_rows($data);
	if($cek > 0){	
		$cari_kd=mysqli_query($koneksi,"SELECT id, alamat, tempat, jabatan, nama, nip, no_pengaturan FROM tbpengaturan_surat WHERE id_kel='$kd_kel' and id_kategori='15'");
		$tm_cari=mysqli_fetch_array($cari_kd);
		$nip_jwb=$tm_cari['nip'];
		$nm_jwb=$tm_cari['nama'];
		...
		echo"<script>window.alert('Pengaturan Surat Keterangan Waqaf Belum ada. Silahkan Buat Pengaturan Suratnya.');window.location=('pengaturan_surat.php');</script>";		
	}	
	...
	if(isset($_POST['btnsimpan'])) {	
		...
		$title="SURAT KETERANGAN WAQAF ".$txtnama;		
...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="index.php" class="">Home</a> 
    ...
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">Layanan Surat - Form Buat Surat Keterangan Waqaf</h2>
    </div>
            ...
            <div class="flex">
                <div class="flex-row items-center w-1/2 mr-2">
                    <div class="w-full border-b border-gray-300 pb-3">
                        <h4 class="text-lg font-medium mr-auto">Biodata Warga ( Yang Mewaqafkan )</h4>
                    </div>
...
<textarea class="input w-full border mt-2" id="txtalamat" name="txtalamat" required></textarea>
                ...
                <div class="flex-row items-center w-1/2 mr-2">
                    <div class="w-full border-b border-gray-300 pb-3">
                        <h4 class="text-lg font-medium mr-auto">Data Tanah Waqaf</h4>
                    </div>

                    <div class="grant_type_target flex-row items-center w-full mx-2">
                        <div class="w-full mt-4">
                            <label class="mb-2 block">Detail Ukuran (LD/LB/P)</label>
                            <input type="hidden" name="grant_type_name" value="Tanah Bangunan">
                        </div>

                        <div class="flex">
                            <div class="relative mr-2">
                                <input type="number" name="txthibah1" id="txthibah1" class="input border w-full" placeholder="Lebar Depan">
                            ...
                            <div class="relative mx-2">
                                <input type="number" name="txthibah2" id="txthibah2" class="input border w-full" placeholder="Lebar Belakang">
                                <div class="absolute top-0 right-0 rounded-r w-10 h-full flex items-center justify-center bg-gray-100  border text-gray-600">M</div>
                            </div>
                            <div class="relative ml-2">
                                <input type="number" name="txthibah3" id="txthibah3" class="input border w-full" placeholder="Panjang">
                                <div class="absolute top-0 right-0 rounded-r w-10 h-full flex items-center justify-center bg-gray-100  border text-gray-600">M</div>
                            </div>
                        </div>

                        <div class="w-full mt-4">
                            <label class="mb-2 block">Detail Lokasi</label>
                        </div>
                        ...
                        <div class="w-full mt-4">
                            <label class="mb-2 block">Saksi - saksi : </label>
                        </div>

                        <div class="flex-row mt-2">
                            <div class="w-full">
								<input type="text" class="input w-full border mt-2" id="txtnamasaksi1" name="txtnamasaksi1" autocomplete="off" required placeholder="Nama Saksi Pertama">
                            </div>
                            <div class="w-full mt-4">
								<input type="text" class="input w-full border mt-2" id="txtnamasaksi2" name="txtnamasaksi2" autocomplete="off" required placeholder="Nama Saksi Kedua">
                            </div>
                        </div>
...
function popUp(){
	if (wi) wi.close();
		...
		var _txt7 = $("#txtumur").val();
		var _txt8 = $("#cbopekerjaan").val();
		var _txt9 = $("#txtalamat").val();		
		var _txt10 = $("#txtnamasaksi1").val();	
		var _txt11 = $("#txtnamasaksi2").val();			
		var _txt12 = $("#txthibah1").val();			
		var _txt13 = $("#txthibah2").val();			
		var _txt14 = $("#txthibah3").val();			
		var _txt15 = $("#txtlok1").val();		
		var _txt16 = $("#txtlok2").val();		
		var _txt17 = $("#txtlok3").val();				
		var _txt18 = $("#txtbatas1").val();				
		var _txt19 = $("#txtbatas2").val();				
		var _txt20 = $("#txtbatas3").val();				
		var _txt21 = $("#txtbatas4").val();								
				
		var queryString = "?txt1=" + _txt1 + "&txt2=" + _txt2 + "&txt3=" + _txt3 + "&txt4=" + _txt4 + "&txt5=" + _txt5 + "&txt6=" + _txt6 + "&txt7=" + _txt7 + "&txt8=" + _txt8 + "&txt9=" + _txt9 + "&txt10=" + _txt10 + "&txt11=" + _txt11 + "&txt12=" + _txt12 + "&txt13=" + _txt13 + "&txt14=" + _txt14 + "&txt15=" + _txt15 + "&txt16=" + _txt16 + "&txt17=" + _txt17 + "&txt18=" + _txt18 + "&txt19=" + _txt19 + "&txt20=" + _txt20 + "&txt21=" + _txt21;
		wi=window.open("s_waqaf_preview.php" + queryString,"","width=700,height=600,location=no,scrollbars=no,status=no");
}
//-->
</script>
