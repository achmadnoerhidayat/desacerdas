...
<?php include "menu_nopenting01.php"; ?>
...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="index.php" class="">Home</a> 
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Input Nomor Penting</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box"> 
							...
							<form class="form-horizontal" action="nopenting_save.php" method="post">
								...
								<div class="p-5" id="input">
									<div class="preview">
										<div class="mt-3">
											...
											autocomplete="off" required placeholder="Nama Instansi/Badan/Jabatan">
										</div>	
										<div class="mt-3">
											<select class="input pr-12 w-full border col-span-4" id="cbokat" name="cbokat" required>
												<option value="">Kategori</option>
												<?php
													$sql="select id, nama FROM tbkategori_nopenting";
										...
										<div class="mt-3">
											...
											autocomplete="off" required placeholder="No. Telepon">
										</div>										
