										...
										<tr>
											...
											<?php
														$query = mysqli_query($koneksi,"SELECT *, DATE_FORMAT(tbkehadiran.tanggal,'%d/%m/%Y') AS tgl_kehadiran,
                                                                                        ...
                                                                                        tbkehadiran.nip='$nip'")or die(mysql_error);
												//$no =$mulai+1;
        ...
        <div class="flex justify-between items-center">
			<table width="100%">
				<tr>
					...
					<td width="10%">
						<button type="button"  class="button w-20 bg-theme-2 text-white"> <a href="kehadiran-detail.php?id=<?php echo $nip; ?>"> Masuk </a></button>
					</td>
					<td width="10%">
						<button type="button"  class="button w-20 bg-theme-1 text-white"> <a href="kehadiran-detail1.php?id=<?php echo $nip; ?>"> Pulang </a></button>
					</td>	
				</tr>
			</table>
        </div>
...
<?php
        ...
        $tampil = mysqli_query($mysqli, "select * from tbkehadiran where nip='$nip'"); //ambil data dari tabel lokasi
