<?php
	...
	$fld_keterangan=$_GET['txt10'];	
	$fld_nm_tjwb=$_GET['txt11'];
	$fld_jbt_tjwb=$_GET['txt12'];
	$fld_alamat_tjwb=$_GET['txt13'];
	$tanggal_from=$_GET['txt14'];
	$tanggal_to=$_GET['txt15'];	
	$tgl_surat="";
		...
		$cari_kd=mysqli_query($koneksi,"SELECT no_pengaturan 
						FROM tbpengaturan_surat WHERE id_kel='$kd_kel' and id_kategori='8'");
		$tm_cari=mysqli_fetch_array($cari_kd);
