        ...
        <div class="flex justify-between items-center">
			<table width="100%">
				<tr>
					...
					<td width="10%">
						<button type="button"  class="button w-20 bg-theme-1 text-white"> <a href="kehadiran.php"> Masuk </a></button>
					</td>
					<td width="10%">
						<button type="button"  class="button w-20 bg-theme-2 text-white"> <a href="kehadiran1.php"> Pulang </a></button>
					</td>	
				</tr>
			</table>
