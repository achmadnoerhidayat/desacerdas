...
session_start();
	...
	$cari_kd=mysqli_query($koneksi,"SELECT 
							judul, pembuat, isi, DATE_FORMAT(tgl_berita,'%d/%m/%Y') AS tanggal, 
							id_kel, foto_berita 
							FROM tbberita 
							WHERE id_berita='$id'");
	$tm_cari=mysqli_fetch_array($cari_kd);
	$judul=$tm_cari['judul'];
	$pembuat=$tm_cari['pembuat'];
	$isi=$tm_cari['isi'];
	$tanggal=$tm_cari['tanggal'];
	$foto_berita=$tm_cari['foto_berita'];
?>
...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="index.php" class="">Home</a> 
					...
					<a href="berita.php" class="">Berita</a>
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Edit Berita</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
    ...
    <div class="intro-y flex items-center justify-between mt-8">
        <h2 class="text-lg font-medium mr-auto">Edit Berita</h2>
    </div>

    <form class="mt-5" action="berita_edit_save.php" method="POST" enctype="multipart/form-data">
								<input type="hidden" name="txtid" value="<?php echo $id; ?>"/>
        <div class="intro-y col-span-12">
            <div class="intro-y box p-5">
                <div class="grid grid-cols-12 gap-4 gap-y-3">
                    <div class="col-span-12">
                        <label class="text-lg">Upload Cover Berita &nbsp;<a href="javascript:void(0);" onClick="newPopup('peta_detail.php?img=<?php echo $foto_berita; ?>');"><?php echo $foto_berita; ?></a>											</label>
                    ...
                    <div class="col-span-12">
                        ...
                        <input id="txtjudul" name="txtjudul" type="text" class="input w-full border mt-2 flex-1" value="<?php echo $judul; ?>" >
                        
                    </div>
                    <div class="col-span-12">
                        <label>Pembuat Berita</label>
                        <input id="txtpembuat" name="txtpembuat" type="text" class="input w-full border mt-2 flex-1" value="<?php echo $pembuat; ?>">
                    </div>
                    <div class="col-span-12">
                        <label>Isi Berita</label>
                        <textarea id="txtisi" name="txtisi" class="input w-full border mt-2 flex-1 summernote" rows="10"><?php echo $isi; ?></textarea>
                    </div>
                </div>

                <div class="pt-3 text-right">
                    <button type="reset" class="button w-20 border text-gray-700 mr-1">Batal</button>
