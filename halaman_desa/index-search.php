								...
								<div class="box p-5 mt-5">
									...
									<!-- BEGIN: Cek Bansos -->
										<?php
											if($jml_search2<>0) {		
										?>
										<div class="rounded-md flex items-center px-5 py-4 mb-2 bg-theme-14 text-theme-10"> <i data-feather="check" class="w-6 h-6 mr-2"></i> Bansos :  <?php echo $jml_search2; ?> data ditemukan 
											&nbsp;&nbsp;&nbsp;<a href="bansos-daftar-search.php?varsearch=<?php echo $txtsearch; ?>"> <i data-feather="eye" class="w-4 h-4 ml-auto"></i></a> 
										</div>	
										<?php 
											}
										?>	
									...
									<!-- BEGIN: Cek Donasi -->
										<?php
											if($jml_search3<>0) {		
										?>
										<div class="rounded-md flex items-center px-5 py-4 mb-2 bg-theme-14 text-theme-10"> <i data-feather="check" class="w-6 h-6 mr-2"></i> Donasi :  <?php echo $jml_search3; ?> data ditemukan 
											&nbsp;&nbsp;&nbsp;<a href="donasi-daftar-search.php?varsearch=<?php echo $txtsearch; ?>"> <i data-feather="eye" class="w-4 h-4 ml-auto"></i></a> 
										</div>	
										<?php 
											}
										?>	
									...
									<!-- BEGIN: Cek UMKM -->
										<?php
											if($jml_search4<>0) {		
										?>
										<div class="rounded-md flex items-center px-5 py-4 mb-2 bg-theme-14 text-theme-10"> <i data-feather="check" class="w-6 h-6 mr-2"></i> UMKM :  <?php echo $jml_search4; ?> data ditemukan 
											&nbsp;&nbsp;&nbsp;<a href="umkm-daftar-search.php?varsearch=<?php echo $txtsearch; ?>"> <i data-feather="eye" class="w-4 h-4 ml-auto"></i></a> 
										</div>	
										<?php 
											}
										?>	
									...
									<!-- BEGIN: Cek Penduduk -->
										<?php
											if($jml_search12<>0) {		
										?>
										<div class="rounded-md flex items-center px-5 py-4 mb-2 bg-theme-14 text-theme-10"> <i data-feather="check" class="w-6 h-6 mr-2"></i> Data Penduduk :  <?php echo $jml_search12; ?> data ditemukan 
											&nbsp;&nbsp;&nbsp;<a href="penduduk-search.php?varsearch=<?php echo $txtsearch; ?>"> <i data-feather="eye" class="w-4 h-4 ml-auto"></i></a> 
										</div>	
										<?php 
											}
										?>	
