...
session_start();
	...
	if($cek > 0){	
		$cari_kd=mysqli_query($koneksi,"SELECT id, alamat, tempat, jabatan, nama, nip FROM tbpengaturan_surat WHERE id_kel='$kd_kel' and id_kategori='21'");
		$tm_cari=mysqli_fetch_array($cari_kd);
		$nip_jwb=$tm_cari['nip'];
		$nm_jwb=$tm_cari['nama'];
	...
	if(isset($_POST['btnsimpan'])) {				
		...
		foreach ($values as $a){
			mysqli_query($koneksi,"INSERT INTO tbsurat_tugas (fld_nama) VALUES ('$a')");
		}
...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="index.php" class="">Home</a> 
				...
				<form action="s_tugas_save.php" method="POST">
						...
						<div class="flex">
							<div class="flex-row items-center w-1/2 mr-2">
								<div class="w-full pb-3 border-b border-gray-300 flex justify-end">
									...
									<button class="persons button w-auto border border-theme-1 text-theme-1 add-more" type="button">
								...
								<div class="control-group after-add-more">
									...
									<div class="w-full mt-4">
										...
										<input type="text" class="input w-full border mt-2" id="txtjbt[]" name="txtjbt[]" autocomplete="off" required>
									</div>								
									<br>
								</div> 
							</div>
							...
							<div class="flex-row items-center w-1/2 mx-2">
								<div class="w-full pb-3 border-b border-gray-300 flex justify-end">
									...
									<button class="persons button w-auto border border-theme-1 text-theme-1 add-more1" type="button">
									  Tambah Tugas
									</button>
								</div>
								...
								<div class="control-group after-add-more1">
									<div class="w-full">
										...
										<input type="text" class="input w-full border mt-2" id="txttugas[]" name="txttugas[]" autocomplete="off" required>
									</div>
									<br>
								</div> 
...
function popUp(){
	...
	//var _txt1= document.getElementsByName("txtnama[]");
	var _values = document.getElementsByName("txtnama[]");
	...
	//$items= _txt1[];
		...
		//var queryString = "?txt1=" + _txt1;
		//wi=window.open("s_tugas_preview.php" + queryString,"","width=700,height=600,location=no,scrollbars=no,status=no");
