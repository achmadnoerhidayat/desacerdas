...
session_start();
	...
	$id=$_GET['kd'];
	$cari_kd=mysqli_query($koneksi,"SELECT tahun, laju FROM tblajupenduduk where id='$id'");
	$tm_cari=mysqli_fetch_array($cari_kd);	
	$tahun=$tm_cari['tahun'];
	$laju=$tm_cari['laju'];
?>
...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="index.php" class="">Home</a> 
					...
					<a href="laju_penduduk.php" class="">Laju Pertumbuhan Penduduk</a>
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-4">
                        ...
                        <div class="intro-y box">
								...
								<form class="form-horizontal" action="laju_penduduk_edit_proses.php" method="post">
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									<div class="mt-3">
										...
										id="txt1" name="txt1" value="<?php echo $tahun; ?>" autocomplete="off" required >
                                    </div>							
									<div class="mt-3">
															<label><b>Laju Pertumbuhan Penduduk</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txt2" name="txt2" value="<?php echo $laju; ?>" autocomplete="off" required>
                                    </div>
