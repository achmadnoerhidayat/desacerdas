...
session_start();
	...
	$data = mysqli_query($koneksi,"SELECT * FROM tbpengaturan_surat WHERE id_kel='$kd_kel' and id_kategori='2'");
	...
	if($cek > 0){	
		...
		echo"<script>window.alert('Pengaturan Surat Keterangan Usaha Belum ada. Silahkan Buat Pengaturan Suratnya.');window.location=('pengaturan_surat.php');</script>";		
	}
...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="index.php" class="">Home</a> 
    ...
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">Layanan Surat - Form Buat Surat Keterangan Usaha</h2>
    </div>
...
<textarea class="input w-full border mt-2" id="txtalamat" name="txtalamat" required></textarea>
                    ...
                    <div class="w-full mt-4">
                        <label class="mb-2 block">Jenis / Tempat Usaha</label>

                        <div class="flex mt-2">
                            <div class="w-full mr-2">
                                <input type="text" class="input w-full border mt-2" id="txtjusaha" name="txtjusaha" autocomplete="off" required>
                            </div>

                            <div class="w-full ml-2">
									<input type="text" class="input w-full border mt-2" id="txttempatusaha" name="txttempatusaha" autocomplete="off" required>
                            </div>
                        </div>
                    </div>
                </div>
...
function popUp(){
	if (wi) wi.close();	
		var _txt1 = $("#txtjusaha").val();
		var _txt2 = $("#txttempatusaha").val();				
		...
		var queryString = "?txt1=" + _txt1 + "&txt2=" + _txt2 + "&txt4=" + _txt4 + "&txt5=" + _txt5 + "&txt6=" + _txt6 + "&txt7=" + _txt7 + "&txt8=" + _txt8 + "&txt9=" + _txt9 + "&txt11=" + _txt11 + "&txt12=" + _txt12;
		wi=window.open("s_usaha_preview.php" + queryString,"","width=700,height=600,location=no,scrollbars=no,status=no");
}
//-->
</script>
