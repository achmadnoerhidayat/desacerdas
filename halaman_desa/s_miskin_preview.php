<?php
	...
	$cari_kd=mysqli_query($koneksi,"SELECT 
									...
									WHERE id_kel='$kd_kel' and id_kategori='3'");
	$tm_cari=mysqli_fetch_array($cari_kd);
	...
	$html = '<head>
			...
			<div style="text-align: center; margin: 30pt 0;">
				<div style="text-decoration: underline; font-weight: bold;">SURAT KETERANGAN KURANG MAMPU</div>		
				<div>'.$no_surat.'</div>				
			</div>
        ...
        <div style="margin-top: 10pt;">Adalah benar sebagai warga dari Desa '.$fld_nama_kel.', '.$fld_nama_kec.', '.$fld_nama_kab.'.</div>
        <div style="margin-top: 10pt;">Surat Keterangan ini diberikan untuk dapat mengajukan permohonan '.$keperluan_miskin.'.</div>
        <!-- End : Isi Surat -->

        <!-- Catatan Surat -->
        <div style="margin-top: 10pt;">
            <span>
				Demikian surat keterangan tidak mampu ini kami buat sebagimana perlunya semoga dapat digunakan sebagaimana mestinya.
            </span>
        </div>
		'.$dot.'
...
$dompdf->stream('surat_keterangan_miskin.pdf',array("Attachment"=>0));
exit(0);
?>
