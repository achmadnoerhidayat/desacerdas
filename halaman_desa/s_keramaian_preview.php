<?php
	...
	$alamat=$_GET['txt7'];		
	$tanggal_acara=$_GET['txt8'];
	$fld_kegunaan=$_GET['txt9'];	
	$fld_tempat=$_GET['txt10'];	
	$fld_hiburan=$_GET['txt11'];	
	$fld_nm_babinkamtibmas=$_GET['txt12'];
	$fld_jbt_babinkamtibmas=$_GET['txt13'];		
	$tgl_surat="";
		...
		$cari_kd=mysqli_query($koneksi,"SELECT no_pengaturan 
						FROM tbpengaturan_surat WHERE id_kel='$kd_kel' and id_kategori='22'");
		$tm_cari=mysqli_fetch_array($cari_kd);
