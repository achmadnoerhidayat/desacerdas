...
session_start();
	...
	$data = mysqli_query($koneksi,"SELECT * FROM tbpengaturan_surat WHERE id_kel='$kd_kel' and id_kategori='12'");
	$cek = mysqli_num_rows($data);
	if($cek > 0){	
		$cari_kd=mysqli_query($koneksi,"SELECT id, alamat, tempat, jabatan, nama, nip, no_pengaturan FROM tbpengaturan_surat WHERE id_kel='$kd_kel' and id_kategori='12'");
		$tm_cari=mysqli_fetch_array($cari_kd);
		$nip_jwb=$tm_cari['nip'];
		$nm_jwb=$tm_cari['nama'];
		...
		echo"<script>window.alert('Pengaturan Surat Keterangan Lansia Belum ada. Silahkan Buat Pengaturan Suratnya.');window.location=('pengaturan_surat.php');</script>";		
	}
	...
	if(isset($_POST['btnsimpan'])) {	
		...
		$title="SURAT KETERANGAN LANSIA ".$txtnama;		
		...
		$cari_kd=mysqli_query($koneksi,"SELECT count(nomor_surat) as total 
						FROM tbbuatsurat WHERE id_kel='$kd_kel' and id_kategori='12' and 
...
<div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">Layanan Surat - Form Buat Surat Keterangan Lansia</h2>
    </div>
            ...
            <div class="flex">
				...
				<div class="flex-row items-center w-1/2 mr-2">
                    ...
                    <div class="w-full mt-2">
                        <label class="mb-4 block">Alamat</label>
...
<input name="date_of_birth" id="date_of_birth" class="datepicker input w-full border block mx-auto" data-single-mode="true" >
					...
					<div class="flex mt-4">
                        ...
                        <div class="w-full ml-2">
                            <label class="mb-2 block">Penyakit</label>
                            <input type="text" class="input w-full border mt-2" id="txtpenyakit" name="txtpenyakit" autocomplete="off" required>
                        </div>
                    </div>
...
function popUp(){
	if (wi) wi.close();
		...
		var _txt1 = $("#txtnmtjwb").val();
		var _txt2 = $("#txtjbttjwb").val();		
		var _txt3 = $("#txtalamattjwb").val();
		var _txt4 = $("#txtnama").val();
		var _txt5 = $("#txtnik").val();
		...
		wi=window.open("s_lansia_preview.php" + queryString,"","width=700,height=600,location=no,scrollbars=no,status=no");
}
//-->
</script>
