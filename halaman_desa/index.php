                            ...
                            <div class="p-5" id="row-states-table">
                                <div class="preview">
                                    <div class="overflow-x-auto">
                                        <table class="table">
                                            <tbody>
                                                <tr class="bg-theme-1 text-black">
                                                    <td class="border text-center" bgcolor="#00FFFF">
													<a href="layanan_surat.php">SURAT KETERANGAN >></a>
													</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                ...
                                <div class="preview">
                                    <div class="overflow-x-auto">
                                        <table class="table">
                                            <tbody>
                                                <tr class="bg-theme-1 text-black">
                                                    <td class="border text-center" bgcolor="#FF7F50">
													<a href="layanan_surat01.php">SURAT PENGANTAR >></a>
													</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                ...
                                <div class="preview">
                                    <div class="overflow-x-auto">
                                        <table class="table">
                                            <tbody>
                                                <tr class="bg-theme-1 text-black">
                                                    <td class="border text-center" bgcolor="#DC143C">
													<a href="layanan_surat02.php">SURAT IZIN >></a>
													</td>
                                                </tr>
                                            </tbody>
                                        </table>
