...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="index.php" class="">Home</a> 
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Input Berita</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
    ...
    <div class="intro-y flex items-center justify-between mt-8">
        <h2 class="text-lg font-medium mr-auto">Input Berita</h2>
    </div>

    <form class="mt-5" action="berita_save.php" method="POST" enctype="multipart/form-data">
			<input type="hidden" name="txtkdkel" value="<?php echo $kd_kel; ?>"/>	
        <div class="intro-y col-span-12">
            <div class="intro-y box p-5">
                <div class="grid grid-cols-12 gap-4 gap-y-3">
                    <div class="col-span-12">
                        <label class="text-lg">Upload Cover Berita</label>
                    ...
                    <div class="col-span-12">
                        ...
                        <input id="txtjudul" name="txtjudul" type="text" class="input w-full border mt-2 flex-1" >
                        
                    </div>
                    <div class="col-span-12">
                        <label>Pembuat Berita</label>
                        <input id="txtpembuat" name="txtpembuat" type="text" class="input w-full border mt-2 flex-1">
                    </div>
                    <div class="col-span-12">
                        <label>Isi Berita</label>
                        <textarea id="txtisi" name="txtisi" class="input w-full border mt-2 flex-1 summernote" rows="10"></textarea>
                    </div>
                </div>
