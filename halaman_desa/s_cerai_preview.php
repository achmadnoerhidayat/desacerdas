<?php
	...
	$tanggal_cerai=$_GET['txt1'];
	$txtumur=$_GET['txt2'];
	$nama_mantan=$_GET['txt3'];
	$nama=$_GET['txt4'];	
	$nik=$_GET['txt5'];
	...
	$alamat=$_GET['txt12'];
		...
		$cari_kd=mysqli_query($koneksi,"SELECT no_pengaturan 
						FROM tbpengaturan_surat WHERE id_kel='$kd_kel' and id_kategori='6'");
		$tm_cari=mysqli_fetch_array($cari_kd);
...
// === Header ==============									
	$cari_kd=mysqli_query($koneksi,"SELECT 
									...
									WHERE id_kel='$kd_kel' and id_kategori='6'");
	$tm_cari=mysqli_fetch_array($cari_kd);
	...
	$html = '<head>
			...
			<div style="text-align: center; margin: 30pt 0;">
				<div style="text-decoration: underline; font-weight: bold;">SURAT KETERANGAN CERAI</div>		
				<div>'.$no_surat.'</div>				
			</div>
        ...
        <table style="margin: 0 30pt; width: 100%;">
            <tbody>
                ...
                <tr>
                    ...
                    <td style="padding: 1pt 2pt; vertical-align:top; width: 1%;">:</td>
                    <td style="padding: 1pt 2pt; vertical-align:top; width: 65%;">'.$txtumur.'</td>
                </tr>
                <tr>
        ...
        <div style="margin-top: 30pt;">
            Adalah benar-benar memiliki '.$ket_mantan.' '.$nama_mantan.' namun, sejak Tanggal '.$tanggal_cerai.' dengan sampai saat ini telah berpisah dan tidak tinggal serumah lagi.
        </div>
        <div style="margin-top: 30pt;">
            Demikian Surat Keterangan, kami berikan untuk digunakan sebagaimana mestinya.
        </div>
...
$dompdf->stream('surat_keteragan_cerai.pdf',array("Attachment"=>0));
?>
