...
<body>
	...
	header("Content-Disposition: attachment; filename=Laporan Kependudukan Berdasarkan Kelompok Usia-Detail.xls");
	?>
...
$koneksi = mysqli_connect("localhost","kreasiso_potensi","Fy!s_G&z^k$}","kreasiso_potensi");
		...
		$data = mysqli_query($koneksi,"select *, DATE_FORMAT(tgl_lhr,'%d/%m/%Y') AS tanggal FROM tbpenduduk where kode='$kd_kel' and id_dukuh='$id_dukuh'");
		$no = 1;
