								...
								<div class="p-5 grid grid-cols-12 gap-4 gap-y-3">
									<div class="col-span-12">
										<div>
											...
											<input name="assesment-category" type="text" class="input w-full border mt-2 flex-1" placeholder="ex: TIU, TWK">
										</div>

										<div class="mt-5">
											<label>Deskripsi Singkat</label>
											<textarea name="assesment-description" class="input w-full border mt-2 flex-1" cols="10" placeholder="ex: Soal Tes ini termasuk dalam tes intelegensia umum..."></textarea>
										</div>

										<div class="mt-3">
											<label>Waktu Pengerjaan</label>
											<input name="assesment-time" type="number" step="5" class="input w-full border mt-2 flex-1" placeholder="ex: 90">
										</div>
									</div>
								</div>
