...
$html = '<center><h4>Data Kependudukan Berdasarkan RT</h4></center><hr/><br/>';
...
$kd_pekerjaan=$row['kd_pekerjaan'];
    ...
    $html .= "<tr>
		...
		<td align='center' bgcolor='yellow'><font size=2>".$row['rt']."</font></td>
...
$dompdf->stream('Data Kependudukan Berdasarkan RT.pdf');
?>