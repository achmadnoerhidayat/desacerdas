...
<body>
	...
	<table border="1" cellspacing="0" style="width: 100%">
		...
		<?php 
		$sql = mysqli_query($koneksi,"select *, DATE_FORMAT(tgl_lhr,'%d/%m/%Y') AS tanggal from tbpenduduk 
													where kode='$kd_kel' and kk='$txtkk'");
		$no =1;
...
<br>
	<table border="1" cellspacing="0" style="width: 100%">
		...
		<tr>														
			...
			<td align="center"><font size="2"><?php echo $data['passport']; ?></font></td>
			<td align="center"><font size="2"><?php echo $data['kitap']; ?></font></td>
