...
<body>
	...
	header("Content-Disposition: attachment; filename=Data Kependudukan Berdasarkan Pekerjaan.xls");
	?>

	<center>
		<h4>Data Kependudukan Berdasarkan Pekerjaan</h4>
	</center>
	...
	<table border="1">
		<tr>
			...
			<td align="center" bgcolor="yellow"><font size="2">Pekerjaan</font></td>
...
$kd_pekerjaan=$d['kd_pekerjaan'];
	...
	$cari_kd=mysqli_query($koneksi,"select pekerjaan FROM tbpekerjaan where kode='$kd_pekerjaan'");
		...
		<tr>
			...
			<td align="center"><font size="2"><?php echo $d['rt']; ?></font></td>
			<td align="center"><font size="2"><?php echo $d['rw']; ?></font></td>
			...
			<td align="center" bgcolor="yellow"><font size="2"><?php echo $pekerjaan; ?></font></td>
		</tr>
		<?php 
				$no++;
		}
