...
// === Header ==============									
	$cari_kd=mysqli_query($koneksi,"SELECT 
									...
									WHERE id_kel='$kd_kel' and id_kategori='27'");
	$tm_cari=mysqli_fetch_array($cari_kd);
	...
	$html = '<head>
			...
			<div style="text-align: center; margin: 30pt 0;">
				<div style="text-decoration: underline; font-weight: bold;">SURAT IZIN POTONG KAYU</div>		
				<div>'.$no_surat.'</div>				
			</div>
        ...
        <div style="margin-top: 10pt;">
			Bersama ini kami mohon untuk diterbitkan Surat Izin Penebangan Kayu untuk yang bersangkutan sebagai keperluan '.$fld_kegunaan.', yang akan dilaksanakan pada :		
        <table style="margin: 10pt 0 10pt 30pt; width: 100%;">
            <tbody>
                <tr>
                ...
                <tr>
                    <td style="padding: 1pt 2pt; vertical-align:top; width: 34%;">Tempat Penebangan</td>
                    <td style="padding: 1pt 2pt; vertical-align:top; width: 1%;">:</td>
...
$dompdf->stream('surat_izin_potongkayu.pdf',array("Attachment"=>0));
?>
