...
<?php include "menu_umkm02.php"; ?>
            ...
            <div class="content">
                ...
                <div class="top-bar">
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="umkm_daftar.php" class="breadcrumb--active">Daftar UMKM Desa</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                        ...
                        <div class="intro-y box p-5">
										...
										<table class="table table--sm" width="100%"> 
											...
											<?php 
												...
												$result = mysqli_query($koneksi,"SELECT id, nama_umkm FROM tbumkm 
																				where kode='$kd_kel' and nama_umkm like '%$varsearch%'");	
