...
<?php include "menu_profil01.php"; ?>
            ...
            <div class="content">
                ...
                <div class="top-bar">
					...
					<a href="#" class="breadcrumb--active">Validasi Desa - Edit</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
							...
							<form class="form-horizontal" enctype="multipart/form-data" action="profil_edit_proses1.php" method="post">
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									...
									<div class="mt-3">
										...
										id="txtalamat" name="txtalamat" value="<?php echo $alamat; ?>" 
									...
									<div class="mt-3">
										<label><b>Lat</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txtlat" name="txtlat" value="<?php echo $lat_desa; ?>" 
										autocomplete="off" required >
                                    </div>									
									<div class="mt-3">
										<label><b>Long</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txtlong" name="txtlong" value="<?php echo $long_desa; ?>" 
										autocomplete="off" required >
                                    </div>																		
