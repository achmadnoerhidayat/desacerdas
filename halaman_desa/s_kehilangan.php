...
session_start();
	...
	$data = mysqli_query($koneksi,"SELECT * FROM tbpengaturan_surat WHERE id_kel='$kd_kel' and id_kategori='8'");
	$cek = mysqli_num_rows($data);
	if($cek > 0){	
		$cari_kd=mysqli_query($koneksi,"SELECT id, alamat, tempat, jabatan, nama, nip, no_pengaturan FROM tbpengaturan_surat WHERE id_kel='$kd_kel' and id_kategori='8'");
		$tm_cari=mysqli_fetch_array($cari_kd);
		$nip_jwb=$tm_cari['nip'];
		$nm_jwb=$tm_cari['nama'];
		...
		echo"<script>window.alert('Pengaturan Surat Keterangan Kehilangan Belum ada. Silahkan Buat Pengaturan Suratnya.');window.location=('pengaturan_surat.php');</script>";		
	}
	...
	if(isset($_POST['btnsimpan'])) {	
		...
		$txtfrom = ubahformatTgl($_POST['date_of_birth1']);
		$txtto = ubahformatTgl($_POST['date_of_birth2']);		
		
		$cbokel = $_POST['txtkdkel'];
		$txtnama = $_POST['txtnama'];
		$title="SURAT KETERANGAN KEHILANGAN ".$txtnama;		
		...
		$txtlain = $_POST['txtlain'];		

		$txtnmtjwb = $_POST['txtnmtjwb'];
		$txtjbttjwb = $_POST['txtjbttjwb'];
		$txtalamattjwb = $_POST['txtalamattjwb'];	
		...
		$cari_kd=mysqli_query($koneksi,"SELECT count(nomor_surat) as total 
						FROM tbbuatsurat WHERE id_kel='$kd_kel' and id_kategori='8' and 
		...
		mysqli_query($koneksi,"INSERT INTO tbbuatsurat 
							...
							nama, nik, tempat_lhr, tgl_lhr, id_jk, id_agama, kd_pekerjaan, alamat, 
							id_status_kawin,
							fld_keperluan, fld_keterangan, tgl_from, tgl_to,
							fld_nm_tjwb, fld_jbt_tjwb, fld_alamat_tjwb) 
							VALUES 
							('$txtno','$tgl_skr_eng','$title','$cbokel','8',
							'$txtnama','','$txttempatlhr','$txttgl','$cbojk','$cboagama','$cbopekerjaan','$txtalamat',
							'$cbostatus','$txtkeperluan','$txtlain','$txtfrom','$txtto',
'$txtnmtjwb','$txtjbttjwb','$txtalamattjwb')");	
...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="index.php" class="">Home</a> 
    ...
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">Layanan Surat - Form Buat Surat Keterangan Kehilangan</h2>
    </div>
            ...
            <div class="flex">
				...
				<div class="flex-row items-center w-1/2 mr-2">
                    <div class="w-full border-b border-gray-300 pb-3">
                        <h4 class="text-lg font-medium mr-auto">Biodata Penanggung Jawab</h4>
                    </div>

                    <div class="w-full mt-4">
                        <label class="mb-2 block">Nama Lengkap</label>
                        <input type="text" class="input w-full border mt-2" id="txtnmtjwb" name="txtnmtjwb" required autocomplete="off" >
                    </div>

                    <div class="w-full mt-4">
                        <label class="mb-2 block">Jabatan</label>
                        <input type="text" class="input w-full border mt-2" id="txtjbttjwb" name="txtjbttjwb" required autocomplete="off">
                    </div>

                    <div class="w-full mt-4">
                        <label class="mb-2 block">Alamat</label>
						<textarea class="input w-full border mt-2" id="txtalamattjwb" name="txtalamattjwb" required></textarea>						
                    </div>
                ...
                <div class="flex-row items-center w-1/2 mr-2">
                    ...
                    <div class="flex mt-4">
                        ...
                        <div class="w-1/2 ml-2">
                            <label class="mb-4 block">Tanggal Lahir</label>
<input name="date_of_birth" id="date_of_birth" class="datepicker input w-full border block mx-auto" data-single-mode="true" >
                    ...
                    <div class="flex mt-4">
                        <div class="w-full mr-2">
                            <label class="mb-4 block">Jenis Kelamin</label>
                        ...
                        <div class="w-full ml-2">
                            <label class="mb-4 block">Agama</label>
					...
					<div class="w-full mt-4">
                        <label class="mb-2 block">Keperluan</label>
                        <input type="text" class="input w-full border mt-2" id="txtkeperluan" name="txtkeperluan" autocomplete="off" required>
                    </div>

                    <div class="w-full mt-4">
                        <label class="mb-2 block">Keterangan Lain-lain</label>
                        <input type="text" class="input w-full border mt-2" id="txtlain" name="txtlain" autocomplete="off">
                    </div>

                    <div class="flex mt-4">
                        <div class="w-1/2 mr-2">
                            <label class="mb-2 block">Berlaku mulai Tanggal</label>
<input name="date_of_birth1" id="date_of_birth1" class="datepicker input w-full border block mx-auto" data-single-mode="true" >
                        </div>

                        <div class="w-1/2 ml-2">
                            <label class="mb-2 block">sampai Tanggal</label>
...
function popUp(){
	if (wi) wi.close();
		...
		var _txt2 = $("#txttempatlhr").val();		
		var _txt3 = $("#date_of_birth").val();
		var _txt4 = $("#cbojk").val();
		var _txt5 = $("#cboagama").val();
		var _txt6 = $("#cbopekerjaan").val();
		var _txt7 = $("#txtalamat").val();
		var _txt8 = $("#cbostatus").val();
		var _txt9 = $("#txtkeperluan").val();
		var _txt10 = $("#txtlain").val();
		var _txt11 = $("#txtnmtjwb").val();
		var _txt12 = $("#txtjbttjwb").val();	
		var _txt13 = $("#txtalamattjwb").val();	
		var _txt14 = $("#date_of_birth1").val();	
		var _txt15 = $("#date_of_birth2").val();			
			
		var queryString = "?txt1=" + _txt1 + "&txt2=" + _txt2 + "&txt3=" + _txt3 + "&txt4=" + _txt4 + "&txt5=" + _txt5 + "&txt6=" + _txt6 + "&txt7=" + _txt7 + "&txt8=" + _txt8 + "&txt9=" + _txt9 + "&txt10=" + _txt10 + "&txt11=" + _txt11 + "&txt12=" + _txt12 + "&txt13=" + _txt13 + "&txt14=" + _txt14 + "&txt15=" + _txt15;
		wi=window.open("s_kehilangan_preview.php" + queryString,"","width=700,height=600,location=no,scrollbars=no,status=no");
}
//-->
</script>
