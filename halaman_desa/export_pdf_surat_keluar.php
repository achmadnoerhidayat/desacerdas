...
$html = '<center>Buku Agenda Surat Keluar BPD<br>DESA ".$nm_kel."<br>Kecamatan .$nm_kec.<br></center>';
$html .= '<table border="1" cellspacing="0" width="100%">
												<tr>
													<td align="center" rowspan="2"> <b>No</b></td>
													<td align="center" rowspan="2"> <b>Tanggal</b></td>
													<td align="center" colspan="4"> <b>Surat Keluar</b></td>
...
$dompdf->stream('laporan_surat_keluar.pdf');
?>
