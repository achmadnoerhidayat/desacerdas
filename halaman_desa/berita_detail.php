...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="index.php" class="">Home</a> 
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Detail Berita</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
				...
				<div class="intro-y flex items-center justify-between mt-8">
					<h2 class="text-lg font-medium mr-auto">Detail Berita</h2>
					<div class="w-1/4 text-right ">
						<a href="berita_edit.php?id=<?php echo $id; ?>" class="button w-1/2 mr-1 bg-theme-1 text-white">Ubah Berita</a>
						<a href="berita_del1.php?id=<?php echo $id; ?>" class="btnDelete button w-1/2 mr-1 bg-theme-6 text-white">Hapus Berita</a>
					</div>
				</div>

				<div class="mt-5 intro-y col-span-12">
					<img class="w-full" src="<?php echo $foto_berita; ?>" alt="<?php echo $judul; ?>">
					<div class="intro-y box p-5">
						<div class="grid grid-cols-12 gap-4 gap-y-3">
							<div class="col-span-12">
								<h1 class="text-4xl"><?php echo $judul; ?></h1>
								<p class="text-sm my-3">
									<span class="mr-2"><b>Editor :</b> <?php echo $pembuat; ?></span>
									<span class="ml-2"><b>Tanggal :</b> <?php echo $tanggal ?></span>
								</p>
								<p class="text-md text-justify"><?php echo $isi; ?></p>
							</div>
						</div>
					</div>
				</div>
