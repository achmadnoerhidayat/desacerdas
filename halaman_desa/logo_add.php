<?php
	...
	if(isset($_POST['btnsimpan'])) {
		...
		mysqli_query($koneksi,"UPDATE tbprofil SET logo_desa='$folder1' WHERE kode='$cbokel'");
		echo"<script>window.alert('File Logo Berhasil Disimpan!');window.location=('validasi_desa.php');</script>";		
	}	
?>
...
<?php include "menu_profil01.php"; ?>
            ...
            <div class="content">
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="index.php" class="">Home</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="validasi_desa.php" class="breadcrumb--active">Validasi Desa-Upload Logo</a> </div>
                    <!-- END: Breadcrumb -->
    ...
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">Upload Logo</h2>
    </div>
        ...
        <div class="col-span-12">
			...
			<input type="hidden" name="txtkdkel" value="<?php echo $kd_kel; ?>"/>				
                    <div class="p-5">
                        <div>
							<!-- File Upload -->
							<label class="text-lg">Upload Logo Desa</label>
							<input type="file" id="id-input-file-1" name="id-input-file-1" class="input w-full border mt-2" required  />
							<span class="text-red-500">*</span>
							<span class="text-xs">Tipe File PNG,JPEG, Ukuran Maksimum 5Mb</span>
                        </div>
...
var uploadField = document.getElementById("id-input-file-1");
