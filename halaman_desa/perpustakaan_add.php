...
<?php include "menu_perpustakaan01.php"; ?>
...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="index.php" class="">Home</a> 
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Input Perpustakaan</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
			...
			<form class="form-horizontal" enctype="multipart/form-data" action="perpustakaan_save.php" method="post">
			<input type="hidden" name="txtkdkel" value="<?php echo $kd_kel; ?>"/>
                            <div class="p-5" id="input">
                                <div class="preview">
					<div class="mt-3">
                                        	<input type="text" class="input w-full border mt-2" 
						id="txtjudul" name="txtjudul" autocomplete="off" required placeholder="Nama Buku/Dokumen">
                                    	</div>	
					<div class="mt-3">
                                        	<input type="text" class="input w-full border mt-2" 
						id="txtrak" name="txtrak" autocomplete="off" required placeholder="Kode Rak">
                                    	</div>
					<div class="mt-3">
                                        	<input type="text" class="input w-full border mt-2" 
						id="txtjml" name="txtjml" autocomplete="off" required placeholder="Jumlah Buku/Dokumen">
                                    	</div>
