...
session_start();
	...
	$id=$_GET['id'];
	$cari_kd=mysqli_query($koneksi,"SELECT * FROM tbperpustakaan WHERE id_perpustakaan='$id'");
	$tm_cari=mysqli_fetch_array($cari_kd);
	$judul=$tm_cari['nama_buku'];
	$rak=$tm_cari['kode_rak'];
	$jml=$tm_cari['jumlah'];
?>
...
<?php include "menu_perpustakaan02.php"; ?>
...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="index.php" class="">Home</a> 
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Edit Perpustakaan</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
			...
			<form class="form-horizontal" enctype="multipart/form-data" action="perpustakaan_edit_save.php" method="post">
								<input type="hidden" name="txtid" value="<?php echo $id; ?>"/>
                            <div class="p-5" id="input">
                                <div class="preview">
					<div class="mt-3">
                                        	<input type="text" class="input w-full border mt-2" 
						id="txtjudul" name="txtjudul" autocomplete="off" value="<?php echo $judul; ?>">
                                    	</div>	
					<div class="mt-3">
                                        	<input type="text" class="input w-full border mt-2" 
						id="txtrak" name="txtrak" autocomplete="off" value="<?php echo $rak; ?>">
                                    	</div>
					<div class="mt-3">
                                        	<input type="text" class="input w-full border mt-2" 
						id="txtjml" name="txtjml" autocomplete="off" value="<?php echo $jml; ?>">
                                    	</div>
